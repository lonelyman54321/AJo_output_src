...
final class AFd1iSDK$5
extends Lambda
implements Function0 {
    private /* synthetic */ AFd1iSDK getMediationNetwork;

    public AFd1iSDK$5(AFd1iSDK aFd1iSDK) {
        this.getMediationNetwork = aFd1iSDK;
        super(0);
    }

    public final AFd1qSDK getCurrencyIso4217Code() {
        Object object = this.getMediationNetwork;
        Object[] objectArray = new Object[]{object};
        int n3 = (int)System.currentTimeMillis();
        object = ((AFd1kSDK)AFd1iSDK.getRevenue(objectArray, 83028355, -83028355, n3)).getMediationNetwork();
