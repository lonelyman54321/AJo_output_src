...
final class SizeKt$statusBarsHeight$1
extends Lambda
implements gx0_2 {
    final /* synthetic */ float $additional;

    public SizeKt$statusBarsHeight$1(float f5) {
        this.$additional = f5;
        super(3);
    }
    ...
    public final LP1 invoke(LP1 lP1, b30_0 b30_02, int n3) {
        ...
        WindowInsets$Type windowInsets$Type = ((WindowInsets)b30_02.j(kb2_02)).getStatusBars();
        VerticalSide verticalSide = VerticalSide.Top;
