...
extends Enum {
    ...
    static {
        ...
        int n3 = 1;
        END_ARRAY = jsonToken9 = new JsonToken("END_ARRAY", n3);
        int n4 = 2;
        BEGIN_OBJECT = jsonToken8 = new JsonToken("BEGIN_OBJECT", n4);
        int n7 = 3;
        END_OBJECT = jsonToken7 = new JsonToken("END_OBJECT", n7);
        ...
        int n8 = 9;
        END_DOCUMENT = jsonToken = new JsonToken("END_DOCUMENT", n8);
        JsonToken[] jsonTokenArray = new JsonToken[10];
        jsonTokenArray[0] = jsonToken10;
        jsonTokenArray[n3] = jsonToken9;
        jsonTokenArray[n4] = jsonToken8;
        jsonTokenArray[n7] = jsonToken7;
