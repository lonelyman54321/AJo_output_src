...
extends TypeAdapter {
    ...
    public CollectionTypeAdapterFactory$Adapter(Gson gson, Type type2, TypeAdapter typeAdapter, ObjectConstructor objectConstructor) {
        TypeAdapterRuntimeTypeWrapper typeAdapterRuntimeTypeWrapper = new TypeAdapterRuntimeTypeWrapper(gson, typeAdapter, type2);
