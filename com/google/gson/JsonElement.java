...
public abstract class JsonElement {
    ...
    public JsonArray getAsJsonArray() {
        ...
        CharSequence charSequence = new StringBuilder("Not a JSON Array: ");
    ...
    public JsonNull getAsJsonNull() {
        ...
        CharSequence charSequence = new StringBuilder("Not a JSON Null: ");
        charSequence.append(this);
        charSequence = charSequence.toString();
        IllegalStateException illegalStateException = new IllegalStateException((String)charSequence);
        throw illegalStateException;
    ...
    public JsonObject getAsJsonObject() {
        ...
        CharSequence charSequence = new StringBuilder("Not a JSON Object: ");
        charSequence.append(this);
        charSequence = charSequence.toString();
        IllegalStateException illegalStateException = new IllegalStateException((String)charSequence);
        throw illegalStateException;
    ...
    public JsonPrimitive getAsJsonPrimitive() {
        ...
        CharSequence charSequence = new StringBuilder("Not a JSON Primitive: ");
        charSequence.append(this);
        charSequence = charSequence.toString();
        IllegalStateException illegalStateException = new IllegalStateException((String)charSequence);
        throw illegalStateException;
