...
extends TransportContext {
        ...
        block6: {
            ...
            block8: {
                block7: {
                    ...
                    if (bl4 && (bl3 = (object2 = this.priority).equals(object = ((TransportContext)object).getPriority()))) break block8;
                }
                bl2 = false;
            }
            return bl2;
    ...
    public int hashCode() {
        int n3 = this.backendName.hashCode();
        int n4 = 1000003;
        n3 = (n3 ^ n4) * n4;
        int n7 = Arrays.hashCode(this.extras);
        n3 = (n3 ^ n7) * n4;
        n4 = ((Object)((Object)this.priority)).hashCode();
        return n3 ^ n4;
    }
}
