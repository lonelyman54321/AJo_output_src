...
implements Factory {
    ...
    public static Uploader_Factory create(Provider provider, Provider provider2, Provider provider3, Provider provider4, Provider provider5, Provider provider6, Provider provider7, Provider provider8, Provider provider9) {
        Uploader_Factory uploader_Factory = new Uploader_Factory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9);
    ...
    public Uploader get() {
        ...
        Object object9 = object = this.uptimeClockProvider.get();
        object9 = (Clock)object;
        Object object10 = object = this.clientHealthMetricsStoreProvider.get();
        object10 = (ClientHealthMetricsStore)object;
        return Uploader_Factory.newInstance((Context)object2, (BackendRegistry)object3, (EventStore)object4, (WorkScheduler)object5, (Executor)object6, (SynchronizationGuard)object7, (Clock)object8, (Clock)object9, (ClientHealthMetricsStore)object10);
    }
}
