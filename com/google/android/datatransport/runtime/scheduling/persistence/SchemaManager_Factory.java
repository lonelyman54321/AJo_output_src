...
implements Factory {
    ...
    public static SchemaManager newInstance(Context context, String string2, int n3) {
        SchemaManager schemaManager = new SchemaManager(context, string2, n3);
    ...
    public SchemaManager get() {
        ...
        int n3 = (Integer)this.schemaVersionProvider.get();
        return SchemaManager_Factory.newInstance(context, string2, n3);
    }
}
