...
extends AndroidClientInfo {
    ...
    private AutoValue_AndroidClientInfo(Integer n3, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9, String string10, String string11, String string12) {
        this.sdkVersion = n3;
        this.model = string2;
    ...
    public /* synthetic */ AutoValue_AndroidClientInfo(Integer n3, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9, String string10, String string11, String string12, AutoValue_AndroidClientInfo$1 autoValue_AndroidClientInfo$1) {
        this(n3, string2, string3, string4, string5, string6, string7, string8, string9, string10, string11, string12);
    }
    ...
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder("AndroidClientInfo{sdkVersion=");
