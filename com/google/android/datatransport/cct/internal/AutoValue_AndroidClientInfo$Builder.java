...
extends AndroidClientInfo$Builder {
    ...
    public AndroidClientInfo build() {
        ...
        AutoValue_AndroidClientInfo autoValue_AndroidClientInfo = new AutoValue_AndroidClientInfo(n3, string2, string3, string4, string5, string6, string7, string8, string9, string10, string11, string12, null);
    ...
    public AndroidClientInfo$Builder setSdkVersion(Integer n3) {
        this.sdkVersion = n3;
        return this;
    }
}
