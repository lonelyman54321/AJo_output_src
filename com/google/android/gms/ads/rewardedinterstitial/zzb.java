...
implements Runnable {
    ...
    public /* synthetic */ zzb(Context context, String string2, AdRequest adRequest, RewardedInterstitialAdLoadCallback rewardedInterstitialAdLoadCallback) {
        this.zza = context;
        this.zzb = string2;
        this.zzc = adRequest;
    ...
    public final void run() {
        ...
        try {
            ...
            zzbwj.zza(context).zzh(illegalStateException, "RewardedInterstitialAd.load");
            return;
        }
