...
extends AbstractSafeParcelable {
    ...
    public void writeToParcel(Parcel parcel, int n3) {
        ...
        string3 = this.addressStreet;
        SafeParcelWriter.writeString(parcel, 7, string3, false);
        string3 = this.addressCity;
        SafeParcelWriter.writeString(parcel, 8, string3, false);
        string3 = this.addressState;
        SafeParcelWriter.writeString(parcel, 9, string3, false);
        string3 = this.addressZip;
        SafeParcelWriter.writeString(parcel, 10, string3, false);
        string3 = this.licenseNumber;
        SafeParcelWriter.writeString(parcel, 11, string3, false);
        string3 = this.issueDate;
        SafeParcelWriter.writeString(parcel, 12, string3, false);
        string3 = this.expiryDate;
        SafeParcelWriter.writeString(parcel, 13, string3, false);
        string3 = this.birthDate;
        SafeParcelWriter.writeString(parcel, 14, string3, false);
        string3 = this.issuingCountry;
        SafeParcelWriter.writeString(parcel, 15, string3, false);
