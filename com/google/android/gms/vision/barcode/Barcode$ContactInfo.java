...
extends AbstractSafeParcelable {
    ...
    public void writeToParcel(Parcel parcel, int n3) {
        ...
        Barcode$PersonName barcode$PersonName = this.name;
        SafeParcelWriter.writeParcelable(parcel, 2, barcode$PersonName, n3, false);
        Object[] objectArray = this.organization;
        ...
        SafeParcelWriter.writeTypedArray(parcel, 5, objectArray, n3, false);
        objectArray = this.emails;
        SafeParcelWriter.writeTypedArray(parcel, 6, objectArray, n3, false);
        objectArray = this.urls;
        SafeParcelWriter.writeStringArray(parcel, 7, (String[])objectArray, false);
        objectArray = this.addresses;
        SafeParcelWriter.writeTypedArray(parcel, 8, objectArray, n3, false);
