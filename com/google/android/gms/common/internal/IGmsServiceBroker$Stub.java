...
implements IGmsServiceBroker {
     ...
     */
    public final boolean onTransact(int var1_1, Parcel var2_2, Parcel var3_3, int var4_4) {
        block16: {
            block17: {
                block18: {
                    if (var1_1 <= 0 || var1_1 > (var5_5 = 0xFFFFFF)) break block16;
                    var2_2.enforceInterface("com.google.android.gms.common.internal.IGmsServiceBroker");
                    var6_6 = var2_2.readStrongBinder();
                    var5_5 = 0;
                    var7_7 = null;
                    var8_8 /* !! */  = var6_6 == null ? null : ((var9_9 = (var8_8 /* !! */  = var6_6.queryLocalInterface("com.google.android.gms.common.internal.IGmsCallbacks")) instanceof IGmsCallbacks) != 0 ? (IGmsCallbacks)var8_8 /* !! */  : new zzab(var6_6));
                    var4_4 = 46;
                    var9_9 = 1;
                    if (var1_1 == var4_4) {
                    ...
                    if (var1_1 == var11_13) {
                        var1_1 = var2_2.readInt();
                        if (var1_1 != 0) {
                            var10_11 = (zzal)zzal.CREATOR.createFromParcel(var2_2);
                        }
                    ...
                    var2_2.readInt();
                    var11_13 = 4;
                    if (var1_1 == var11_13) break block17;
                    var2_2.readString();
