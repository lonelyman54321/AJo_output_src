...
implements Person$Cover$CoverInfo {
    ...
    static {
        ...
        String string2 = "leftImageOffset";
    ...
    public zzr$zzb$zza(Set set, int n3, int n4, int n7) {
        this.zzap = set;
        this.zzw = n3;
        this.zzbs = n4;
        this.zzbt = n7;
    ...
    public final boolean equals(Object object) {
        boolean bl2;
        boolean bl3 = object instanceof zzr$zzb$zza;
        if (!bl3) {
            return false;
        }
        bl3 = true;
        ...
        while (bl2 = iterator.hasNext()) {
            ...
            if (!(bl4 ? !(bl4 = ((zzr$zzb$zza)object).isFieldSet((FastJsonResponse$Field)object3)) || !(bl2 = (object2 = this.getFieldValue((FastJsonResponse$Field)object3)).equals(object3 = ((zzr$zzb$zza)object).getFieldValue((FastJsonResponse$Field)object3))) : (bl2 = ((zzr$zzb$zza)object).isFieldSet((FastJsonResponse$Field)object3)))) continue;
            return false;
        }
        return bl3;
    }
