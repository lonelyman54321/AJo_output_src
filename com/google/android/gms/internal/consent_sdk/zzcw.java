...
public final class zzcw {
    public static int zza(int n3, int n4, String string2) {
        ...
        if (n3 >= 0) {
            ...
            objectArray[n7] = n10;
            object = zzcx.zza("%s (%s) must be less than size (%s)", objectArray);
        } else {
            object = n3;
            Object[] objectArray = new Object[n7];
            objectArray[0] = string3;
            objectArray[n8] = object;
            object = zzcx.zza("%s (%s) must not be negative", objectArray);
        }
    ...
    public static int zzb(int n3, int n4, String object) {
        ...
        String string2 = zzcw.zzd(n3, n4, "index");
    ...
    public static void zzc(int n3, int n4, int n7) {
        ...
        if (n3 >= 0 && n3 <= n7) {
            if (n4 >= 0 && n4 <= n7) {
                ...
                object = zzcx.zza("end index (%s) must not be less than start index (%s)", objectArray);
            } else {
                object = zzcw.zzd(n4, n7, "end index");
            }
        } else {
            String string2 = "start index";
            object = zzcw.zzd(n3, n7, string2);
        }
        IndexOutOfBoundsException indexOutOfBoundsException = new IndexOutOfBoundsException((String)object);
        throw indexOutOfBoundsException;
    }
    ...
    private static String zzd(int n3, int n4, String string2) {
        ...
        if (n3 < 0) {
            ...
            objectArray[n7] = n10;
            return zzcx.zza("%s (%s) must not be negative", objectArray);
        }
        if (n4 >= 0) {
            Integer n14 = n3;
            Integer n15 = n4;
            ...
            objectArray[n7] = n14;
            objectArray[n8] = n15;
            return zzcx.zza("%s (%s) must not be greater than size (%s)", objectArray);
        }
