...
public final class zzbgt {
    public static final zzbfv zza = zzbfv.zzb("gads:dynamite_load:fail:sample_rate", 10000L);
    ...
    public static final zzbfv zzg = zzbfv.zza("gads:trapped_exception_sample_rate", 0.01);
}
