...
import com.google.android.play.core.splitinstall.zzax;
...
extends zzv {
    ...
    public zzam(zzbc zzbc2, TaskCompletionSource taskCompletionSource, List list, TaskCompletionSource taskCompletionSource2) {
        this.zzc = zzbc2;
        this.zza = list;
    ...
    public final void zzc() {
        ...
        try {
            ...
            ((zzu)object2).zzc(remoteException, "deferredUninstall(%s)", objectArray);
            object2 = this.zzb;
        ...
        zzax zzax2 = new zzax(zzbc2, taskCompletionSource);
        object3.zzg((String)object2, (List)object, (Bundle)objectArray, zzax2);
    }
}
