...
import com.google.android.play.core.splitinstall.internal.zza;
import com.google.android.play.core.splitinstall.internal.zzb;
import com.google.android.play.core.splitinstall.internal.zzc;
import com.google.android.play.core.splitinstall.internal.zze;
import com.google.android.play.core.splitinstall.internal.zzg;
...
public final class zzi {
    ...
    private static ByteBuffer zzf(ByteBuffer object) {
        ...
        if (n4 >= (n3 = 4)) {
            ...
            if (n4 >= 0) {
                ...
                if (n4 <= n3) {
                    return zzi.zze((ByteBuffer)object, n4);
                }
    ...
    private static void zzh(Map map2, FileChannel fileChannel, long l2, long l3, long l4, ByteBuffer byteBuffer) {
        ...
        if (n7 == 0) {
            ...
            while (n3 < n10) {
                ...
                String string2 = zzi.zzd(n17).concat(" digest of contents did not verify");
    ...
    private static X509Certificate[] zzj(ByteBuffer byteBuffer, Map map2, CertificateFactory certificateFactory) {
        ...
        block53: {
                ...
                block51: {
                    block55: {
                        ...
                        block47: {
                            void var3_6;
                            block49: {
                                x509CertificateArray = zzi.zzf(byteBuffer);
                                object3 = zzi.zzf(byteBuffer);
                                object2 = zzi.zzi(byteBuffer);
                                ...
                                block27: while (true) {
                                    block48: {
                                        ...
                                        ++n8;
                                        try {
                                            comparable = zzi.zzf((ByteBuffer)object3);
            ...
            if (n22 != 0) {
                ...
                object3 = zzi.zzf((ByteBuffer)x509CertificateArray);
                ...
                while ((n8 = (int)(((Buffer)object3).hasRemaining() ? 1 : 0)) != 0) {
                    ...
                    n3 += n4;
                    try {
                        object5 = zzi.zzf((ByteBuffer)object3);
                        ...
                        if (n14 != n10) continue;
                        byArray2 = zzi.zzi((ByteBuffer)object5);
                        continue;
                    }
                    catch (BufferUnderflowException bufferUnderflowException) {
                    }
                ...
                if ((object6 = (Object)map2.put(object6, byArray2)) != null && (n24 = MessageDigest.isEqual((byte[])object6, byArray2)) == 0) {
                    object3 = zzi.zzd(n22).concat(" contents digest does not match the digest specified by a preceding signer");
                    x509CertificateArray = new SecurityException((String)object3);
                    throw x509CertificateArray;
                }
                x509CertificateArray = zzi.zzf((ByteBuffer)x509CertificateArray);
                object3 = new ArrayList();
                n24 = 0;
                object6 = null;
                while (bl2 = x509CertificateArray.hasRemaining()) {
                    n24 += n4;
                    byArray2 = zzi.zzi((ByteBuffer)x509CertificateArray);
                    try {
                        ...
                        zzg zzg2 = new zzg((X509Certificate)object4, byArray2);
                        ((ArrayList)object3).add(zzg2);
                    }
     ...
     * Enabled aggressive exception aggregation
     */
    private static byte[][] zzk(int[] nArray, zzb[] zzbArray) {
        int n8;
        ...
        while (true) {
            ...
            if (n19 >= n18) break;
            n18 = (int)l4;
            byte[] byArray2 = new byte[zzi.zzb(object2[n19]) * n18 + n17];
            byArray2[0] = n15 = 90;
            zzi.zzg(n18, byArray2, n16);
     ...
     * Enabled aggressive exception aggregation
     */
    private static X509Certificate[][] zzl(FileChannel x509CertificateArrayArray, zze object) {
        boolean bl2;
        int n3;
        ...
        try {
            byteBuffer = zze.zze((zze)object);
            byteBuffer = zzi.zzf(byteBuffer);
            n3 = 0;
        }
        catch (IOException iOException) {
        ...
        while (bl2 = byteBuffer.hasRemaining()) {
            ...
            ++n3;
            try {
                X509Certificate[] x509CertificateArray = zzi.zzf(byteBuffer);
                x509CertificateArray = zzi.zzj((ByteBuffer)x509CertificateArray, object2, (CertificateFactory)object3);
        ...
        if (!bl3) {
            long l2 = zze.zza((zze)object);
            long l3 = zze.zzb((zze)object);
            long l4 = zze.zzc((zze)object);
            ByteBuffer byteBuffer2 = zze.zzd((zze)object);
            object3 = x509CertificateArrayArray;
            zzi.zzh((Map)object2, (FileChannel)x509CertificateArrayArray, l2, l3, l4, byteBuffer2);
