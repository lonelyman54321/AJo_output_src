...
public final class zzi {
    ...
    public zzi(String string2) {
        int n3 = Process.myUid();
        int n4 = Process.myPid();
        this.zza = string2 = z41.a("UID: [", "]  PID: [", "] ", n3, n4).concat(string2);
    }

    private static String zze(String string2, String string3, Object ... object) {
    ...
    public final int zza(String string2, Object ... objectArray) {
        ...
        if (bl2) {
            string2 = zzi.zze(this.zza, "Play Store app is either not installed or not the official version", objectArray);
            return Log.e((String)string3, (String)string2);
        }
        return 0;
    }

    public final int zzb(Throwable throwable, String string2, Object ... objectArray) {
        String string3 = "PlayCore";
        boolean bl2 = Log.isLoggable((String)string3, (int)6);
        if (bl2) {
            string2 = zzi.zze(this.zza, string2, objectArray);
            return Log.e((String)string3, (String)string2, (Throwable)throwable);
        }
        return 0;
    }

    public final int zzc(String string2, Object ... objectArray) {
        String string3 = "PlayCore";
