...
extends DateFormatTextWatcher {
    ...
    public RangeDateSelector$2(RangeDateSelector rangeDateSelector, String string2, DateFormat dateFormat, TextInputLayout textInputLayout, CalendarConstraints calendarConstraints, TextInputLayout textInputLayout2, TextInputLayout textInputLayout3, OnSelectionChangedListener onSelectionChangedListener) {
    ...
    public void onInvalidDate() {
        RangeDateSelector.access$202(this.this$0, null);
    ...
    public void onValidDate(Long object) {
        RangeDateSelector.access$202(this.this$0, (Long)object);
        object = this.this$0;
        TextInputLayout textInputLayout = this.val$startTextInput;
        TextInputLayout textInputLayout2 = this.val$endTextInput;
        OnSelectionChangedListener onSelectionChangedListener = this.val$listener;
