...
extends DynamicScheme {
    public SchemeFidelity(Hct hct, boolean bl2, double d2) {
        ...
        TonalPalette tonalPalette3 = TonalPalette.fromHct(DislikeAnalyzer.fixIfDisliked(((TemperatureCache)object).getComplement()));
        d7 = hct.getHue();
