...
extends DynamicScheme {
    public SchemeRainbow(Hct hct, boolean bl2, double d2) {
        Variant variant = Variant.RAINBOW;
        TonalPalette tonalPalette = TonalPalette.fromHueAndChroma(hct.getHue(), 48.0);
