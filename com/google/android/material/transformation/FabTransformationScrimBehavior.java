...
extends ExpandableTransformationBehavior {
    ...
    public FabTransformationScrimBehavior() {
        ...
        long l2 = 150L;
        this.expandTiming = motionTiming = new MotionTiming(75, l2);
        this.collapseTiming = motionTiming = new MotionTiming(0L, l2);
    }
    ...
    private void createScrimAnimation(View view, boolean bl2, boolean bl3, List list, List list2) {
        int n3 = 1;
        float f5 = Float.MIN_VALUE;
        MotionTiming motionTiming = bl2 ? this.expandTiming : this.collapseTiming;
        if (bl2) {
            if (!bl3) {
                view.setAlpha(0.0f);
            }
