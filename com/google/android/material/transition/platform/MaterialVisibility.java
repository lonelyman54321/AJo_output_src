...
extends Visibility {
    ...
    private void maybeApplyThemeValues(Context context, boolean bl2) {
        ...
        TransitionUtils.maybeApplyThemeDuration((Transition)this, context, n3);
        n3 = this.getEasingThemeAttrResId(bl2);
        TimeInterpolator timeInterpolator = this.getDefaultEasingInterpolator(bl2);
        TransitionUtils.maybeApplyThemeInterpolator((Transition)this, context, n3, timeInterpolator);
    }
