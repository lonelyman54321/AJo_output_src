...
import com.google.android.material.transition.platform.TransitionUtils$1;
import com.google.android.material.transition.platform.TransitionUtils$CornerSizeBinaryOperator;
...
class TransitionUtils {
    ...
    public static boolean maybeApplyThemePath(Transition transition2, Context context, int n3) {
        if (n3 != 0 && (context = TransitionUtils.resolveThemePath(context, n3)) != null) {
            transition2.setPathMotion((PathMotion)context);
            return true;
        }
        return false;
    }
    ...
    public static void maybeRemoveTransition(TransitionSet transitionSet, Transition transition2) {
        if (transition2 != null) {
            transitionSet.removeTransition(transition2);
        }
    }
    ...
    public static PathMotion resolveThemePath(Context object, int n3) {
        ...
        if (n7 != 0) {
            ...
            if (n7 == n3) {
                ...
                illegalArgumentException = new PatternPathMotion((Path)object);
