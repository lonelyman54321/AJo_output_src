...
import com.google.android.material.transition.MaterialContainerTransform$TransitionDrawable$1;
import com.google.android.material.transition.MaterialContainerTransform$TransitionDrawable$2;
...
extends Drawable {
    ...
    private MaterialContainerTransform$TransitionDrawable(PathMotion pathMotion, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, float f5, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, float f6, int n3, int n4, int n7, int n8, boolean bl2, boolean bl3, FadeModeEvaluator fadeModeEvaluator, FitModeEvaluator fitModeEvaluator, MaterialContainerTransform$ProgressThresholdsGroup materialContainerTransform$ProgressThresholdsGroup, boolean bl4) {
        ...
        this.debugPath = object = new Path();
        object = view;
        this.startView = view;
        ...
        Object object2 = shapeAppearanceModel2;
        this.endShapeAppearanceModel = shapeAppearanceModel2;
        this.endElevation = f6;
        this.entering = bl2;
        this.elevationShadowEnabled = bl3;
        object2 = fadeModeEvaluator;
        this.fadeModeEvaluator = fadeModeEvaluator;
        object2 = fitModeEvaluator;
        this.fitModeEvaluator = fitModeEvaluator;
        object2 = materialContainerTransform$ProgressThresholdsGroup;
        this.progressThresholds = materialContainerTransform$ProgressThresholdsGroup;
        this.drawDebugEnabled = bl4;
        object = (WindowManager)view.getContext().getSystemService("window");
        object2 = new DisplayMetrics();
        object.getDefaultDisplay().getMetrics((DisplayMetrics)object2);
        this.displayWidth = f8 = (float)((DisplayMetrics)object2).widthPixels;
        this.displayHeight = f8 = (float)((DisplayMetrics)object2).heightPixels;
        paint5.setColor(n3);
        paint4.setColor(n4);
        paint3.setColor(n7);
