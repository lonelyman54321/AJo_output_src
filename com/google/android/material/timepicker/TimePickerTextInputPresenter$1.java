...
extends TextWatcherAdapter {
    ...
    public TimePickerTextInputPresenter$1(TimePickerTextInputPresenter timePickerTextInputPresenter) {
    ...
    public void afterTextChanged(Editable object) {
        try {
            ...
            ((TimeModel)object2).setMinute(n3);
            return;
        }
