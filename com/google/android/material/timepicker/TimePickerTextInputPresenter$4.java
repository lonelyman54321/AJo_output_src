...
extends ClickActionDelegate {
    ...
    public TimePickerTextInputPresenter$4(TimePickerTextInputPresenter timePickerTextInputPresenter, Context context, int n3, TimeModel timeModel) {
    ...
    public void onInitializeAccessibilityNodeInfo(View object, C2 c2) {
        ...
        int n3 = this.val$time.getHourContentDescriptionResId();
        String string2 = String.valueOf(this.val$time.getHourForDisplay());
