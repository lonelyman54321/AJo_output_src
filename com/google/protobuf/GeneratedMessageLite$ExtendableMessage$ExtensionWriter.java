...
public class GeneratedMessageLite$ExtendableMessage$ExtensionWriter {
    ...
    public void writeUntil(int n3, CodedOutputStream codedOutputStream) {
        int n4;
        Object object;
        while ((object = this.next) != null && (n4 = ((GeneratedMessageLite$ExtensionDescriptor)(object = (GeneratedMessageLite$ExtensionDescriptor)object.getKey())).getNumber()) < n3) {
            ...
            if (bl2 && (object2 = ((GeneratedMessageLite$ExtensionDescriptor)object).getLiteJavaType()) == (wireFormat$JavaType = WireFormat$JavaType.MESSAGE) && !(bl2 = ((GeneratedMessageLite$ExtensionDescriptor)object).isRepeated())) {
                n4 = ((GeneratedMessageLite$ExtensionDescriptor)object).getNumber();
