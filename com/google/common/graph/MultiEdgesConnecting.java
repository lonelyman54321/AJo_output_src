...
abstract class MultiEdgesConnecting
extends AbstractSet {
    ...
    public UnmodifiableIterator iterator() {
        Iterator iterator = this.outEdgeToNode.entrySet().iterator();
        MultiEdgesConnecting$1 multiEdgesConnecting$1 = new MultiEdgesConnecting$1(this, iterator);
