...
extends AbstractGraphBuilder {
    ...
    public NetworkBuilder expectedEdgeCount(int n3) {
        Optional optional;
        this.expectedEdgeCount = optional = Optional.of(Graphs.checkNonNegative(n3));
        return this;
    }

    public NetworkBuilder expectedNodeCount(int n3) {
        Optional optional;
