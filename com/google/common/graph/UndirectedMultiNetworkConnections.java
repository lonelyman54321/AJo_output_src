...
extends AbstractUndirectedNetworkConnections {
    ...
    private UndirectedMultiNetworkConnections(Map map2) {
        super(map2);
    }
    ...
    public static UndirectedMultiNetworkConnections ofImmutable(Map map2) {
        map2 = ImmutableMap.copyOf(map2);
        UndirectedMultiNetworkConnections undirectedMultiNetworkConnections = new UndirectedMultiNetworkConnections(map2);
        return undirectedMultiNetworkConnections;
    }
    ...
    public Set edgesConnecting(Object object) {
        ...
        UndirectedMultiNetworkConnections$1 undirectedMultiNetworkConnections$1 = new UndirectedMultiNetworkConnections$1(this, map2, object, object);
