...
implements ListIterator {
    ...
    public AbstractMapBasedMultimap$WrappedList$WrappedListIterator(AbstractMapBasedMultimap$WrappedList abstractMapBasedMultimap$WrappedList, int n3) {
        this.this$1 = abstractMapBasedMultimap$WrappedList;
        ListIterator listIterator = abstractMapBasedMultimap$WrappedList.getListDelegate().listIterator(n3);
