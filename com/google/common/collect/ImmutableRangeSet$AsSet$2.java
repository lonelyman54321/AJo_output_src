...
extends AbstractIterator {
    ...
    public ImmutableRangeSet$AsSet$2(ImmutableRangeSet$AsSet object) {
        this.this$1 = object;
        this.rangeItr = object = ImmutableRangeSet.access$000(((ImmutableRangeSet$AsSet)object).this$0).reverse().iterator();
    ...
    public Comparable computeNext() {
        ...
        while (!(bl2 = (object = this.elemItr).hasNext())) {
            ...
            if (bl2) {
                ...
                this.elemItr = object = ContiguousSet.create((Range)object, discreteDomain).descendingIterator();
                continue;
            }
