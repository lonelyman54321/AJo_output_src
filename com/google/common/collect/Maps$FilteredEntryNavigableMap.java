...
extends AbstractNavigableMap {
    ...
    public Maps$FilteredEntryNavigableMap(NavigableMap navigableMap, Predicate predicate) {
        Map map2;
        this.unfiltered = map2 = (NavigableMap)Preconditions.checkNotNull(navigableMap);
        this.entryPredicate = predicate;
        super(navigableMap, predicate);
        this.filteredDelegate = map2;
    }
    ...
    public Iterator descendingEntryIterator() {
        Iterator iterator = this.unfiltered.descendingMap().entrySet().iterator();
    ...
    public void putAll(Map map2) {
        this.filteredDelegate.putAll(map2);
    }
