...
implements RangeMap {
    ...
    public void putCoalescing(Range range, Object object) {
        ...
        if (!bl2 && (bl2 = ((Range)(object2 = this.subRange)).encloses(range))) {
            object2 = this.this$0;
        ...
        block6: {
            ...
            block5: {
                ...
                block4: {
                    ...
                    if ((object = object.floorEntry(object2)) == null || (n4 = ((Cut)(object = ((TreeRangeMap$RangeMapEntry)object.getValue()).getUpperBound())).compareTo((Cut)(object2 = this.subRange.lowerBound))) <= 0) break block4;
                    object = this.subRange.lowerBound;
                    break block5;
                }
                object = TreeRangeMap.access$000(this.this$0);
                object2 = this.subRange.lowerBound;
                if ((object = object.ceilingKey(object2)) == null || (n3 = ((Cut)object).compareTo((Cut)(object2 = this.subRange.upperBound))) >= 0) break block6;
            }
            ...
            if (object2 != null) {
                ...
                int n7 = cut.compareTo(cut2 = this.subRange.upperBound);
                object2 = n7 >= 0 ? this.subRange.upperBound : ((TreeRangeMap$RangeMapEntry)object2.getValue()).getUpperBound();
