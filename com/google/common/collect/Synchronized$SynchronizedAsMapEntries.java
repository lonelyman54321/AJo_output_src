...
extends Synchronized$SynchronizedSet {
    ...
    public Iterator iterator() {
        ...
        Synchronized$SynchronizedAsMapEntries$1 synchronized$SynchronizedAsMapEntries$1 = new Synchronized$SynchronizedAsMapEntries$1(this, iterator);
    ...
    public boolean removeAll(Collection collection) {
        Object object = this.mutex;
        synchronized (object) {
            Iterator iterator = this.delegate();
