...
extends AbstractIterator {
    ...
    public TreeRangeMap$SubRangeMap$1$1(TreeRangeMap$SubRangeMap$1 treeRangeMap$SubRangeMap$1, Iterator iterator) {
    ...
    public Map.Entry computeNext() {
        ...
        if (bl2) {
            ...
            int n3 = ((Cut)serializable2).compareTo((Cut)(serializable = TreeRangeMap$SubRangeMap.access$300((TreeRangeMap$SubRangeMap)this.this$2.this$1).lowerBound));
            if (n3 <= 0) {
