...
public abstract class MultimapBuilder$MultimapBuilderWithKeys {
    ...
    public MultimapBuilder$ListMultimapBuilder arrayListValues(int n3) {
        CollectPreconditions.checkNonnegative(n3, "expectedValuesPerKey");
        MultimapBuilder$MultimapBuilderWithKeys$1 multimapBuilder$MultimapBuilderWithKeys$1 = new MultimapBuilder$MultimapBuilderWithKeys$1(this, n3);
    ...
    public MultimapBuilder$SetMultimapBuilder hashSetValues(int n3) {
        CollectPreconditions.checkNonnegative(n3, "expectedValuesPerKey");
        MultimapBuilder$MultimapBuilderWithKeys$3 multimapBuilder$MultimapBuilderWithKeys$3 = new MultimapBuilder$MultimapBuilderWithKeys$3(this, n3);
    ...
    public MultimapBuilder$SetMultimapBuilder linkedHashSetValues(int n3) {
        CollectPreconditions.checkNonnegative(n3, "expectedValuesPerKey");
        MultimapBuilder$MultimapBuilderWithKeys$4 multimapBuilder$MultimapBuilderWithKeys$4 = new MultimapBuilder$MultimapBuilderWithKeys$4(this, n3);
