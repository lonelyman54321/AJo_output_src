...
public abstract class MultimapBuilder {
    ...
    public static MultimapBuilder$MultimapBuilderWithKeys hashKeys(int n3) {
        CollectPreconditions.checkNonnegative(n3, "expectedKeys");
        MultimapBuilder$1 multimapBuilder$1 = new MultimapBuilder$1(n3);
    ...
    public static MultimapBuilder$MultimapBuilderWithKeys linkedHashKeys(int n3) {
        CollectPreconditions.checkNonnegative(n3, "expectedKeys");
        MultimapBuilder$2 multimapBuilder$2 = new MultimapBuilder$2(n3);
