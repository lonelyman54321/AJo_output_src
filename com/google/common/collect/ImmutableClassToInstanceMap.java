...
Serializable {
    ...
    public static ImmutableClassToInstanceMap copyOf(Map map2) {
        boolean bl2 = map2 instanceof ImmutableClassToInstanceMap;
        if (bl2) {
            return (ImmutableClassToInstanceMap)map2;
        }
        ImmutableClassToInstanceMap$Builder immutableClassToInstanceMap$Builder = new ImmutableClassToInstanceMap$Builder();
        return immutableClassToInstanceMap$Builder.putAll(map2).build();
    }
