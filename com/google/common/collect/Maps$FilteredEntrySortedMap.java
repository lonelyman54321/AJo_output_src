...
implements SortedMap {
    ...
    public Object lastKey() {
        ...
        Object object;
        boolean bl2;
        while (!(bl2 = this.apply(sortedMap = sortedMap.lastKey(), object = NullnessCasts.uncheckedCastNullableTToT(this.unfiltered.get(sortedMap))))) {
            object = this.sortedMap();
            sortedMap = object.headMap(sortedMap);
        }
        return sortedMap;
    }
