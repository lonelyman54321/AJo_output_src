...
implements NavigableSet {
    ...
    public Iterator descendingIterator() {
        Iterator iterator = this.getSortedSetDelegate().descendingIterator();
        AbstractMapBasedMultimap$WrappedCollection$WrappedIterator abstractMapBasedMultimap$WrappedCollection$WrappedIterator = new AbstractMapBasedMultimap$WrappedCollection$WrappedIterator(this, iterator);
