...
extends AbstractNavigableMap {
    ...
    public Iterator descendingEntryIterator() {
        ...
        Cut cut = Cut.belowValue(this.restriction.upperBound);
        object = (Cut)((Ordering)object).min(object2, cut);
        object2 = this.rangesByLowerBound;
        cut = (Cut)((Cut)object).endpoint();
        ...
        object = object2.headMap(cut, bl2).descendingMap().values().iterator();
    ...
    public Iterator entryIterator() {
        ...
        if (bl2) {
            ...
            object2 = (Cut)this.lowerBoundWindow.lowerBound.endpoint();
    ...
    public Range get(Object object) {
        int n3 = object instanceof Cut;
        if (n3 == 0) return null;
        try {
            object = (Cut)object;
            Object object2 = this.lowerBoundWindow;
            n3 = ((Range)object2).contains((Comparable)object);
            if (n3 == 0) return null;
            object2 = this.restriction;
            object2 = ((Range)object2).lowerBound;
            n3 = ((Cut)object).compareTo((Cut)object2);
            if (n3 < 0) return null;
            object2 = this.restriction;
            ...
            object2 = this.restriction;
            object2 = ((Range)object2).lowerBound;
            n3 = (int)(((Cut)object).equals(object2) ? 1 : 0);
            if (n3 != 0) {
                object2 = this.rangesByLowerBound;
