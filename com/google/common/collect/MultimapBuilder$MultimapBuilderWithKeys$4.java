...
extends MultimapBuilder$SetMultimapBuilder {
    ...
    public MultimapBuilder$MultimapBuilderWithKeys$4(MultimapBuilder$MultimapBuilderWithKeys multimapBuilder$MultimapBuilderWithKeys, int n3) {
    ...
    public SetMultimap build() {
        ...
        MultimapBuilder$LinkedHashSetSupplier multimapBuilder$LinkedHashSetSupplier = new MultimapBuilder$LinkedHashSetSupplier(n3);
        return Multimaps.newSetMultimap(map2, multimapBuilder$LinkedHashSetSupplier);
    }
}
