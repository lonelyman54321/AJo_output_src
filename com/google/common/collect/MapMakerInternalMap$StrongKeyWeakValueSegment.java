...
final class MapMakerInternalMap$StrongKeyWeakValueSegment
extends MapMakerInternalMap$Segment {
    private final ReferenceQueue queueForValues;

    public MapMakerInternalMap$StrongKeyWeakValueSegment(MapMakerInternalMap referenceQueue, int n3) {
        super((MapMakerInternalMap)((Object)referenceQueue), n3);
        this.queueForValues = referenceQueue = new ReferenceQueue();
    }

    public static /* synthetic */ ReferenceQueue access$500(MapMakerInternalMap$StrongKeyWeakValueSegment mapMakerInternalMap$StrongKeyWeakValueSegment) {
    ...
    public void setWeakValueReferenceForTesting(MapMakerInternalMap$InternalEntry mapMakerInternalMap$InternalEntry, MapMakerInternalMap$WeakValueReference mapMakerInternalMap$WeakValueReference) {
        mapMakerInternalMap$InternalEntry = this.castForTesting(mapMakerInternalMap$InternalEntry);
        MapMakerInternalMap$WeakValueReference mapMakerInternalMap$WeakValueReference2 = MapMakerInternalMap$StrongKeyWeakValueEntry.access$400((MapMakerInternalMap$StrongKeyWeakValueEntry)mapMakerInternalMap$InternalEntry);
        MapMakerInternalMap$StrongKeyWeakValueEntry.access$402((MapMakerInternalMap$StrongKeyWeakValueEntry)mapMakerInternalMap$InternalEntry, mapMakerInternalMap$WeakValueReference);
