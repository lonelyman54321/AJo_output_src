...
public final class Multimaps {
    ...
    private static SetMultimap filterFiltered(FilteredSetMultimap multimap, Predicate predicate) {
        predicate = Predicates.and(multimap.entryPredicate(), predicate);
        multimap = multimap.unfiltered();
        FilteredEntrySetMultimap filteredEntrySetMultimap = new FilteredEntrySetMultimap((SetMultimap)multimap, predicate);
    ...
    public static SetMultimap forMap(Map map2) {
        Multimaps$MapMultimap multimaps$MapMultimap = new Multimaps$MapMultimap(map2);
    ...
    public static ImmutableListMultimap index(Iterator iterator, Function function) {
        ...
        while (bl2 = iterator.hasNext()) {
            ...
            immutableListMultimap$Builder.put(object, e2);
        }
    ...
    public static Multimap invertFrom(Multimap object, Multimap multimap) {
        ...
        while (bl2 = object.hasNext()) {
            ...
            entry = entry.getKey();
            multimap.put(v4, entry);
        }
        return multimap;
    }

    public static ListMultimap newListMultimap(Map map2, Supplier supplier) {
        Multimaps$CustomListMultimap multimaps$CustomListMultimap = new Multimaps$CustomListMultimap(map2, supplier);
        return multimaps$CustomListMultimap;
    }

    public static Multimap newMultimap(Map map2, Supplier supplier) {
        Multimaps$CustomMultimap multimaps$CustomMultimap = new Multimaps$CustomMultimap(map2, supplier);
        return multimaps$CustomMultimap;
    }

    public static SetMultimap newSetMultimap(Map map2, Supplier supplier) {
        Multimaps$CustomSetMultimap multimaps$CustomSetMultimap = new Multimaps$CustomSetMultimap(map2, supplier);
        return multimaps$CustomSetMultimap;
    }

    public static SortedSetMultimap newSortedSetMultimap(Map map2, Supplier supplier) {
        Multimaps$CustomSortedSetMultimap multimaps$CustomSortedSetMultimap = new Multimaps$CustomSortedSetMultimap(map2, supplier);
