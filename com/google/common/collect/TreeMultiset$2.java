...
implements Iterator {
    ...
    public TreeMultiset$2(TreeMultiset object) {
        this.this$0 = object;
        this.current = object = TreeMultiset.access$1300((TreeMultiset)object);
    }
    ...
    public Multiset$Entry next() {
        ...
        if (bl2) {
            ...
            treeMultiset$AvlNode = TreeMultiset$AvlNode.access$700(this.current);
            ...
            if (treeMultiset$AvlNode == treeMultiset$AvlNode2) {
                ...
                this.current = treeMultiset$AvlNode = TreeMultiset$AvlNode.access$700(this.current);
            }
            return object;
        }
