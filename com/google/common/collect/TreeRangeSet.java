...
implements Serializable {
    ...
    public void add(Range serializable) {
        ...
        if (entry != null) {
            ...
            cut = ((Range)((Object)entry)).upperBound;
            n3 = cut.compareTo(cut2);
            if (n3 >= 0) {
                cut2 = ((Range)((Object)entry)).upperBound;
                n4 = cut2.compareTo((Cut)serializable);
                if (n4 >= 0) {
                    serializable = ((Range)((Object)entry)).upperBound;
                }
                cut2 = ((Range)((Object)entry)).lowerBound;
            }
        }
        if ((entry = this.rangesByLowerBound.floorEntry(serializable)) != null) {
            entry = (Range)entry.getValue();
            cut = ((Range)((Object)entry)).upperBound;
            n3 = cut.compareTo((Cut)serializable);
            if (n3 >= 0) {
                serializable = ((Range)((Object)entry)).upperBound;
            }
        }
    ...
    public void remove(Range serializable) {
        ...
        if ((object = object.lowerEntry(serializable2)) != null) {
            ...
            n3 = serializable2.compareTo(cut);
            if (n3 >= 0) {
                n3 = (int)(serializable.hasUpperBound() ? 1 : 0);
                if (n3 != 0 && (n3 = (serializable2 = ((Range)object).upperBound).compareTo(cut = serializable.upperBound)) >= 0) {
