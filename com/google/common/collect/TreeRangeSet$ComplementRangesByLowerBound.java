    ...
    public Iterator entryIterator() {
        block9: {
            ...
            block8: {
                ...
                block7: {
                    object2 = this.complementLowerBoundWindow;
                    boolean bl3 = ((Range)object2).hasLowerBound();
                    if (bl3) {
                        boolean bl4;
                        BoundType boundType;
                        object2 = this.positiveRangesByUpperBound;
                        serializable = (Cut)this.complementLowerBoundWindow.lowerEndpoint();
                        ...
                        object2 = object2.tailMap(serializable, bl4).values();
                    } else {
                        object2 = this.positiveRangesByUpperBound.values();
                    }
                    object2 = Iterators.peekingIterator(object2.iterator());
                    serializable = this.complementLowerBoundWindow;
                    object = Cut.belowAll();
                    bl2 = ((Range)serializable).contains((Comparable)object);
                    if (!bl2 || (bl2 = object2.hasNext()) && (serializable = ((Range)object2.peek()).lowerBound) == (object = Cut.belowAll())) break block7;
                    serializable = Cut.belowAll();
                    break block8;
                }
                bl2 = object2.hasNext();
                if (!bl2) break block9;
                serializable = ((Range)object2.next()).upperBound;
            }
            object = new TreeRangeSet$ComplementRangesByLowerBound$1(this, (Cut)serializable, (PeekingIterator)object2);
            return object;
        }
        return Iterators.emptyIterator();
    }
