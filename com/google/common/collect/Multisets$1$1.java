...
extends AbstractIterator {
    final /* synthetic */ Multisets$1 this$0;
    final /* synthetic */ Iterator val$iterator1;
    final /* synthetic */ Iterator val$iterator2;

    public Multisets$1$1(Multisets$1 multisets$1, Iterator iterator, Iterator iterator2) {
    ...
    public Multiset$Entry computeNext() {
        ...
        if (n3 != 0) {
            ...
            n3 = object.getCount();
            int n4 = this.this$0.val$multiset2.count(object2);
            n3 = Math.max(n3, n4);
