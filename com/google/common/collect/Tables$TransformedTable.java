...
extends AbstractTable {
    ...
    public Iterator cellIterator() {
        Iterator iterator = this.fromTable.cellSet().iterator();
    ...
    public Object get(Object object, Object object2) {
        ...
        if (bl2) {
            ...
            object = NullnessCasts.uncheckedCastNullableTToT(table.get(object, object2));
    ...
    public Object remove(Object object, Object object2) {
        ...
        if (bl2) {
            Function function = this.function;
            Table table = this.fromTable;
            object = NullnessCasts.uncheckedCastNullableTToT(table.remove(object, object2));
            object = function.apply(object);
        } else {
            object = null;
        }
