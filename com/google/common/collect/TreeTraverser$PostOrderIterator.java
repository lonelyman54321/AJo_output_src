...
extends AbstractIterator {
    ...
    private TreeTraverser$PostOrderNode expand(Object object) {
        Iterator iterator = this.this$0.children(object).iterator();
        TreeTraverser$PostOrderNode treeTraverser$PostOrderNode = new TreeTraverser$PostOrderNode(object, iterator);
