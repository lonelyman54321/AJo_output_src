...
implements RangeMap {
    ...
    public void remove(Range serializable) {
        ...
        if ((object = object.lowerEntry(object2)) != null && (n3 = (cut2 = ((TreeRangeMap$RangeMapEntry)(object2 = (TreeRangeMap$RangeMapEntry)object.getValue())).getUpperBound()).compareTo(cut = serializable.lowerBound)) > 0) {
            cut2 = ((TreeRangeMap$RangeMapEntry)object2).getUpperBound();
            n3 = cut2.compareTo(cut = serializable.upperBound);
            if (n3 > 0) {
        ...
        if ((object = object.lowerEntry(object2)) != null && (n3 = (cut2 = ((TreeRangeMap$RangeMapEntry)(object2 = (TreeRangeMap$RangeMapEntry)object.getValue())).getUpperBound()).compareTo(cut = serializable.upperBound)) > 0) {
            cut2 = serializable.upperBound;
