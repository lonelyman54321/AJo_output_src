...
import com.google.common.cache.LocalCache$WeakAccessEntry;
import com.google.common.cache.ReferenceEntry;
import java.lang.ref.ReferenceQueue;

final class LocalCache$EntryFactory$6
extends LocalCache$EntryFactory {
    ...
    public ReferenceEntry newEntry(LocalCache$Segment object, Object object2, int n3, ReferenceEntry referenceEntry) {
        ...
        LocalCache$WeakAccessEntry localCache$WeakAccessEntry = new LocalCache$WeakAccessEntry((ReferenceQueue)object, object2, n3, referenceEntry);
        return localCache$WeakAccessEntry;
    }
}
