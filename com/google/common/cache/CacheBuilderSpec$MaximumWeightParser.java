...
extends CacheBuilderSpec$LongParser {
    public void parseLong(CacheBuilderSpec cacheBuilderSpec, long l2) {
        ...
        l4 = cacheBuilderSpec.maximumSize;
        if (l4 == null) {
            bl2 = true;
        }
        Preconditions.checkArgument(bl2, "maximum size was already set to %s", (Object)l4);
        cacheBuilderSpec.maximumWeight = l3 = Long.valueOf(l2);
    }
}
