...
final class Types$TypeVariableImpl {
    ...
    public boolean equals(Object object) {
        ...
        if (bl2) {
            ...
            if (object != null && (bl2 = Proxy.isProxyClass(object2 = object.getClass())) && (bl2 = (object2 = Proxy.getInvocationHandler(object)) instanceof Types$TypeVariableInvocationHandler)) {
                boolean bl4;
                object2 = this.name;
                Object object3 = ((Types$TypeVariableImpl)(object = Types$TypeVariableInvocationHandler.access$500((Types$TypeVariableInvocationHandler)Proxy.getInvocationHandler(object)))).getName();
    ...
    public int hashCode() {
        int n3 = this.genericDeclaration.hashCode();
        int n4 = this.name.hashCode();
        return n3 ^ n4;
    }
