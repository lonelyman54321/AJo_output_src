...
public final class Functions {
    ...
    public static Function forMap(Map map2) {
        Functions$FunctionForMapNoDefault functions$FunctionForMapNoDefault = new Functions$FunctionForMapNoDefault(map2);
        return functions$FunctionForMapNoDefault;
    }

    public static Function forMap(Map map2, Object object) {
        Functions$ForMapWithDefault functions$ForMapWithDefault = new Functions$ForMapWithDefault(map2, object);
