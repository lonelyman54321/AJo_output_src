...
public final class MediaType {
    ...
    static {
        ...
        String string6 = FONT_TYPE;
        ANY_FONT_TYPE = MediaType.createConstant(string6, (String)object);
        ...
        String string7 = "xml";
        XML_UTF_8 = MediaType.createConstantUtf8((String)object2, string7);
        ...
        String string8 = "ogg";
        OGG_AUDIO = MediaType.createConstant(string3, string8);
        String string9 = "webm";
        WEBM_AUDIO = MediaType.createConstant(string3, string9);
        ...
        OGG_VIDEO = MediaType.createConstant(string4, string8);
        QUICKTIME = MediaType.createConstant(string4, "quicktime");
        WEBM_VIDEO = MediaType.createConstant(string4, string9);
        ...
        APPLICATION_XML_UTF_8 = MediaType.createConstantUtf8(string5, string7);
        ...
        JWT = MediaType.createConstant(string5, "jwt");
        ...
        OGG_CONTAINER = MediaType.createConstant(string5, string8);
        ...
        FONT_COLLECTION = MediaType.createConstant(string6, "collection");
        FONT_OTF = MediaType.createConstant(string6, "otf");
        FONT_SFNT = MediaType.createConstant(string6, "sfnt");
        FONT_TTF = MediaType.createConstant(string6, "ttf");
        FONT_WOFF = MediaType.createConstant(string6, "woff");
        FONT_WOFF2 = MediaType.createConstant(string6, "woff2");
    ...
    public static /* synthetic */ String a(String string2) {
        return MediaType.lambda$computeToString$0(string2);
    }
    ...
    private static void consumeSeparator(MediaType$Tokenizer mediaType$Tokenizer, char c2) {
        CharMatcher charMatcher = LINEAR_WHITE_SPACE;
        mediaType$Tokenizer.consumeTokenIfPresent(charMatcher);
        mediaType$Tokenizer.consumeCharacter(c2);
        mediaType$Tokenizer.consumeTokenIfPresent(charMatcher);
    }
    ...
    private static MediaType create(String string2, String string3, Multimap object) {
        ...
        return (MediaType)MoreObjects.firstNonNull((MediaType)KNOWN_TYPES.get(object), object);
    }
    ...
    public static MediaType createFontType(String string2) {
        return MediaType.create(FONT_TYPE, string2);
    }
    ...
    private static /* synthetic */ String lambda$computeToString$0(String string2) {
        CharMatcher charMatcher = TOKEN_MATCHER;
        boolean bl2 = charMatcher.matchesAllOf(string2);
        if (!bl2 || (bl2 = string2.isEmpty())) {
            string2 = MediaType.escapeAndQuote(string2);
        }
        return string2;
    }
    ...
    private Map parametersAsMap() {
        ...
        in1_0 in1_02 = new Object();
        return Maps.transformValues(immutableMap, (Function)in1_02);
    }
    ...
    public static MediaType parse(String string2) {
        ...
        block8: {
            Preconditions.checkNotNull(string2);
            object2 = new MediaType$Tokenizer(string2);
            try {
                object = TOKEN_MATCHER;
                string3 = ((MediaType$Tokenizer)object2).consumeToken((CharMatcher)object);
                char c2 = '/';
                MediaType.consumeSeparator((MediaType$Tokenizer)object2, c2);
                object = ((MediaType$Tokenizer)object2).consumeToken((CharMatcher)object);
                immutableListMultimap$Builder = ImmutableListMultimap.builder();
                break block8;
            }
            catch (IllegalStateException illegalStateException) {}
            string2 = cP.a("Could not parse '", string2, "'");
            IllegalArgumentException illegalArgumentException = new IllegalArgumentException(string2, illegalStateException);
            throw illegalArgumentException;
        }
        while (true) {
            char c3;
            if ((c3 = ((MediaType$Tokenizer)object2).hasMore()) == '\u0000') {
                object2 = immutableListMultimap$Builder.build();
                return MediaType.create(string3, (String)object, (Multimap)object2);
            }
            c3 = ';';
            MediaType.consumeSeparator((MediaType$Tokenizer)object2, c3);
            Object object3 = TOKEN_MATCHER;
            String string4 = ((MediaType$Tokenizer)object2).consumeToken((CharMatcher)object3);
            char c5 = '=';
            MediaType.consumeSeparator((MediaType$Tokenizer)object2, c5);
            c5 = ((MediaType$Tokenizer)object2).previewChar();
            char c6 = '\"';
            if (c6 != c5) {
                object3 = ((MediaType$Tokenizer)object2).consumeToken((CharMatcher)object3);
            } else {
                ((MediaType$Tokenizer)object2).consumeCharacter(c6);
                object3 = new StringBuilder();
                while (c6 != (c5 = ((MediaType$Tokenizer)object2).previewChar())) {
                    Object object4;
                    char c7 = '\\';
                    c5 = ((MediaType$Tokenizer)object2).previewChar();
                    if (c7 == c5) {
                        ((MediaType$Tokenizer)object2).consumeCharacter(c7);
                        object4 = CharMatcher.ascii();
                        c5 = ((MediaType$Tokenizer)object2).consumeCharacter((CharMatcher)object4);
                        ((StringBuilder)object3).append(c5);
                        continue;
                    }
                    object4 = QUOTED_TEXT_MATCHER;
                    object4 = ((MediaType$Tokenizer)object2).consumeToken((CharMatcher)object4);
    ...
    public Optional charset() {
        ...
        if (serializable == null) {
            ...
            Object object = ((ImmutableList)this.parameters.get(CHARSET_ATTRIBUTE)).iterator();
            String string2 = null;
            while (bl2 = object.hasNext()) {
                String string3 = (String)object.next();
                if (string2 == null) {
                    serializable = Optional.of(Charset.forName(string3));
                    string2 = string3;
                    continue;
                }
                boolean bl3 = string2.equals(string3);
                if (bl3) continue;
                object = UX.c("Multiple charset values defined: ", string2, ", ", string3);
    ...
    public int hashCode() {
        ...
        if (n3 == 0) {
            ...
            Map map2 = this.parametersAsMap();
            int n4 = 3;
            Object[] objectArray = new Object[n4];
            objectArray[0] = string2;
            objectArray[1] = string3;
            objectArray[2] = map2;
            this.hashCode = n3 = Objects.hashCode(objectArray);
        }
        return n3;
    }
    ...
    public MediaType withParameters(String object, Iterable object2) {
        ...
        return (MediaType)MoreObjects.firstNonNull((MediaType)KNOWN_TYPES.get(object2), object2);
    }
