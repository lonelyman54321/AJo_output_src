...
public final class Futures$FutureCombiner {
    ...
    public ListenableFuture run(Runnable runnable2, Executor executor) {
        Futures$FutureCombiner$1 futures$FutureCombiner$1 = new Futures$FutureCombiner$1(this, runnable2);
