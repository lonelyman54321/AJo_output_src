...
class ClosingFuture$Combiner4$2
implements ClosingFuture$Combiner$AsyncCombiningCallable {
    final /* synthetic */ ClosingFuture$Combiner4 this$0;
    final /* synthetic */ ClosingFuture$Combiner4$AsyncClosingFunction4 val$function;

    public ClosingFuture$Combiner4$2(ClosingFuture$Combiner4 closingFuture$Combiner4, ClosingFuture$Combiner4$AsyncClosingFunction4 closingFuture$Combiner4$AsyncClosingFunction4) {
        this.this$0 = closingFuture$Combiner4;
        this.val$function = closingFuture$Combiner4$AsyncClosingFunction4;
    }
    ...
    public ClosingFuture call(ClosingFuture$DeferredCloser closingFuture$DeferredCloser, ClosingFuture$Peeker closingFuture$Peeker) {
        ClosingFuture$Combiner4$AsyncClosingFunction4 closingFuture$Combiner4$AsyncClosingFunction4 = this.val$function;
        ...
        return closingFuture$Combiner4$AsyncClosingFunction4.apply(closingFuture$DeferredCloser, object2, object3, object4, object5);
    }
