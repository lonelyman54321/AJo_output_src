...
class CycleDetectingLockFactory$LockGraphNode {
    ...
    public void checkAcquiredLocks(CycleDetectingLockFactory$Policy cycleDetectingLockFactory$Policy, List object) {
        boolean bl2;
        object = object.iterator();
        while (bl2 = object.hasNext()) {
            CycleDetectingLockFactory$LockGraphNode cycleDetectingLockFactory$LockGraphNode = (CycleDetectingLockFactory$LockGraphNode)object.next();
