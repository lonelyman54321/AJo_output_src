...
extends CycleDetectingLockFactory {
    ...
    public CycleDetectingLockFactory$WithExplicitOrdering(CycleDetectingLockFactory$Policy cycleDetectingLockFactory$Policy, Map map2) {
        super(cycleDetectingLockFactory$Policy, null);
        this.lockGraphNodes = map2;
    }
