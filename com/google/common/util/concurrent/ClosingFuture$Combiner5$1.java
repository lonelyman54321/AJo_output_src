...
class ClosingFuture$Combiner5$1
implements ClosingFuture$Combiner$CombiningCallable {
    final /* synthetic */ ClosingFuture$Combiner5 this$0;
    final /* synthetic */ ClosingFuture$Combiner5$ClosingFunction5 val$function;

    public ClosingFuture$Combiner5$1(ClosingFuture$Combiner5 closingFuture$Combiner5, ClosingFuture$Combiner5$ClosingFunction5 closingFuture$Combiner5$ClosingFunction5) {
        this.this$0 = closingFuture$Combiner5;
        this.val$function = closingFuture$Combiner5$ClosingFunction5;
    }

    public Object call(ClosingFuture$DeferredCloser closingFuture$DeferredCloser, ClosingFuture$Peeker closingFuture$Peeker) {
        ClosingFuture$Combiner5$ClosingFunction5 closingFuture$Combiner5$ClosingFunction5 = this.val$function;
        ...
        return closingFuture$Combiner5$ClosingFunction5.apply(closingFuture$DeferredCloser, object2, object3, object4, object5, object6);
    }
