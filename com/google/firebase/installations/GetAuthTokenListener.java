...
implements StateListener {
    ...
    public boolean onStateReached(PersistedInstallationEntry object) {
        ...
        if (bl2 && !(bl2 = ((Utils)(object2 = this.utils)).isAuthTokenExpired((PersistedInstallationEntry)object))) {
            ...
            long l2 = ((PersistedInstallationEntry)object).getExpiresInSecs();
            installationTokenResult$Builder = installationTokenResult$Builder.setTokenExpirationTimestamp(l2);
            l2 = ((PersistedInstallationEntry)object).getTokenCreationEpochInSecs();
            object = installationTokenResult$Builder.setTokenCreationTimestamp(l2).build();
