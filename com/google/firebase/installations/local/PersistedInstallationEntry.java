...
public abstract class PersistedInstallationEntry {
    ...
    public static PersistedInstallationEntry$Builder builder() {
        ...
        long l2 = 0L;
        persistedInstallationEntry$Builder = ((AutoValue_PersistedInstallationEntry$Builder)persistedInstallationEntry$Builder).setTokenCreationEpochInSecs(l2);
        ...
        return persistedInstallationEntry$Builder.setRegistrationStatus(persistedInstallation$RegistrationStatus).setExpiresInSecs(l2);
    }
    ...
    public PersistedInstallationEntry withAuthToken(String string2, long l2, long l3) {
        return this.toBuilder().setAuthToken(string2).setExpiresInSecs(l2).setTokenCreationEpochInSecs(l3).build();
    }
    ...
    public PersistedInstallationEntry withRegisteredFid(String object, String string2, long l2, String string3, long l3) {
        ...
        return ((PersistedInstallationEntry$Builder)object).setRegistrationStatus(persistedInstallation$RegistrationStatus).setAuthToken(string3).setRefreshToken(string2).setExpiresInSecs(l3).setTokenCreationEpochInSecs(l2).build();
    }
