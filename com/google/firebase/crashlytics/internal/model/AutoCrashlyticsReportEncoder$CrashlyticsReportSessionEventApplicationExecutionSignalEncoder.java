...
final class AutoCrashlyticsReportEncoder$CrashlyticsReportSessionEventApplicationExecutionSignalEncoder
implements ObjectEncoder {
    private static final FieldDescriptor ADDRESS_DESCRIPTOR;
    private static final FieldDescriptor CODE_DESCRIPTOR;
    static final AutoCrashlyticsReportEncoder$CrashlyticsReportSessionEventApplicationExecutionSignalEncoder INSTANCE;
    ...
    public void encode(CrashlyticsReport$Session$Event$Application$Execution$Signal crashlyticsReport$Session$Event$Application$Execution$Signal, ObjectEncoderContext objectEncoderContext) {
        ...
        long l2 = crashlyticsReport$Session$Event$Application$Execution$Signal.getAddress();
