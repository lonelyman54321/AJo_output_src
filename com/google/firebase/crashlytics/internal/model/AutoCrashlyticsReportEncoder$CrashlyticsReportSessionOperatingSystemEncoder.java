...
final class AutoCrashlyticsReportEncoder$CrashlyticsReportSessionOperatingSystemEncoder
implements ObjectEncoder {
    private static final FieldDescriptor BUILDVERSION_DESCRIPTOR;
    static final AutoCrashlyticsReportEncoder$CrashlyticsReportSessionOperatingSystemEncoder INSTANCE;
    ...
    public void encode(CrashlyticsReport$Session$OperatingSystem crashlyticsReport$Session$OperatingSystem, ObjectEncoderContext objectEncoderContext) {
        ...
        int n3 = crashlyticsReport$Session$OperatingSystem.getPlatform();
