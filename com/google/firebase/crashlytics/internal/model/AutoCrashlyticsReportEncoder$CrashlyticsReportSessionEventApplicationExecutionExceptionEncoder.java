...
final class AutoCrashlyticsReportEncoder$CrashlyticsReportSessionEventApplicationExecutionExceptionEncoder
implements ObjectEncoder {
    private static final FieldDescriptor CAUSEDBY_DESCRIPTOR;
    private static final FieldDescriptor FRAMES_DESCRIPTOR;
    static final AutoCrashlyticsReportEncoder$CrashlyticsReportSessionEventApplicationExecutionExceptionEncoder INSTANCE;
    ...
    public void encode(CrashlyticsReport$Session$Event$Application$Execution$Exception crashlyticsReport$Session$Event$Application$Execution$Exception, ObjectEncoderContext objectEncoderContext) {
        ...
        int n3 = crashlyticsReport$Session$Event$Application$Execution$Exception.getOverflowCount();
