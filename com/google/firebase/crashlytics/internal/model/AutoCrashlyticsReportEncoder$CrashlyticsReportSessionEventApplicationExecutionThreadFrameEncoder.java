...
final class AutoCrashlyticsReportEncoder$CrashlyticsReportSessionEventApplicationExecutionThreadFrameEncoder
implements ObjectEncoder {
    private static final FieldDescriptor FILE_DESCRIPTOR;
    private static final FieldDescriptor IMPORTANCE_DESCRIPTOR;
    static final AutoCrashlyticsReportEncoder$CrashlyticsReportSessionEventApplicationExecutionThreadFrameEncoder INSTANCE;
    ...
    public void encode(CrashlyticsReport$Session$Event$Application$Execution$Thread$Frame crashlyticsReport$Session$Event$Application$Execution$Thread$Frame, ObjectEncoderContext objectEncoderContext) {
        ...
        long l2 = crashlyticsReport$Session$Event$Application$Execution$Thread$Frame.getPc();
        ...
        l2 = crashlyticsReport$Session$Event$Application$Execution$Thread$Frame.getOffset();
        objectEncoderContext.add(fieldDescriptor, l2);
        fieldDescriptor = IMPORTANCE_DESCRIPTOR;
        int n3 = crashlyticsReport$Session$Event$Application$Execution$Thread$Frame.getImportance();
