...
final class AutoCrashlyticsReportEncoder$CrashlyticsReportSessionEventApplicationExecutionBinaryImageEncoder
implements ObjectEncoder {
    private static final FieldDescriptor BASEADDRESS_DESCRIPTOR;
    static final AutoCrashlyticsReportEncoder$CrashlyticsReportSessionEventApplicationExecutionBinaryImageEncoder INSTANCE;
    ...
    public void encode(CrashlyticsReport$Session$Event$Application$Execution$BinaryImage object, ObjectEncoderContext objectEncoderContext) {
        ...
        long l2 = ((CrashlyticsReport$Session$Event$Application$Execution$BinaryImage)object).getBaseAddress();
        objectEncoderContext.add(fieldDescriptor, l2);
        fieldDescriptor = SIZE_DESCRIPTOR;
        l2 = ((CrashlyticsReport$Session$Event$Application$Execution$BinaryImage)object).getSize();
        objectEncoderContext.add(fieldDescriptor, l2);
