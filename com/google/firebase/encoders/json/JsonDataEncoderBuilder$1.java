...
class JsonDataEncoderBuilder$1
implements DataEncoder {
    ...
    public void encode(Object object, Writer writer) {
        Map map2 = JsonDataEncoderBuilder.access$100(this.this$0);
        Map map3 = JsonDataEncoderBuilder.access$200(this.this$0);
        ...
        JsonValueObjectEncoderContext jsonValueObjectEncoderContext = new JsonValueObjectEncoderContext(writer, map2, map3, objectEncoder, bl2);
