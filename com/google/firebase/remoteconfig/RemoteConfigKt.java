...
import com.google.firebase.remoteconfig.CustomSignals$Builder;
...
public final class RemoteConfigKt {
    public static final CustomSignals customSignals(Function1 object) {
        Intrinsics.checkNotNullParameter(object, "builder");
        CustomSignals$Builder customSignals$Builder = new CustomSignals$Builder();
        object.invoke(customSignals$Builder);
        object = customSignals$Builder.build();
        Intrinsics.checkNotNullExpressionValue(object, "Builder().apply(builder).build()");
        return object;
    }
