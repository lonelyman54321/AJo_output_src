...
implements GaugeMetricOrBuilder {
    ...
    public static /* synthetic */ void access$1200(GaugeMetric gaugeMetric, int n3) {
        gaugeMetric.removeCpuMetricReadings(n3);
    }

    public static /* synthetic */ void access$1300(GaugeMetric gaugeMetric, int n3, AndroidMemoryReading androidMemoryReading) {
        gaugeMetric.setAndroidMemoryReadings(n3, androidMemoryReading);
    }
    ...
    public static /* synthetic */ void access$1500(GaugeMetric gaugeMetric, int n3, AndroidMemoryReading androidMemoryReading) {
        gaugeMetric.addAndroidMemoryReadings(n3, androidMemoryReading);
    }
    ...
    public static /* synthetic */ void access$1800(GaugeMetric gaugeMetric, int n3) {
        gaugeMetric.removeAndroidMemoryReadings(n3);
    }
    ...
    public static /* synthetic */ void access$700(GaugeMetric gaugeMetric, int n3, CpuMetricReading cpuMetricReading) {
        gaugeMetric.setCpuMetricReadings(n3, cpuMetricReading);
    }
    ...
    public static /* synthetic */ void access$900(GaugeMetric gaugeMetric, int n3, CpuMetricReading cpuMetricReading) {
        gaugeMetric.addCpuMetricReadings(n3, cpuMetricReading);
    }
    ...
    private void addAndroidMemoryReadings(int n3, AndroidMemoryReading androidMemoryReading) {
        androidMemoryReading.getClass();
        this.ensureAndroidMemoryReadingsIsMutable();
        this.androidMemoryReadings_.add(n3, androidMemoryReading);
    }
    ...
    private void addCpuMetricReadings(int n3, CpuMetricReading cpuMetricReading) {
        cpuMetricReading.getClass();
        this.ensureCpuMetricReadingsIsMutable();
        this.cpuMetricReadings_.add(n3, cpuMetricReading);
    }
    ...
    private void removeAndroidMemoryReadings(int n3) {
        this.ensureAndroidMemoryReadingsIsMutable();
        this.androidMemoryReadings_.remove(n3);
    }

    private void removeCpuMetricReadings(int n3) {
        this.ensureCpuMetricReadingsIsMutable();
        this.cpuMetricReadings_.remove(n3);
    }

    private void setAndroidMemoryReadings(int n3, AndroidMemoryReading androidMemoryReading) {
        androidMemoryReading.getClass();
        this.ensureAndroidMemoryReadingsIsMutable();
        this.androidMemoryReadings_.set(n3, androidMemoryReading);
    }

    private void setCpuMetricReadings(int n3, CpuMetricReading cpuMetricReading) {
        cpuMetricReading.getClass();
        this.ensureCpuMetricReadingsIsMutable();
        this.cpuMetricReadings_.set(n3, cpuMetricReading);
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite$MethodToInvoke objectArray, Object clazz, Object object) {
        byte by2 = 1;
        object = GaugeMetric$1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke;
    ...
    public AndroidMemoryReading getAndroidMemoryReadings(int n3) {
        return (AndroidMemoryReading)this.androidMemoryReadings_.get(n3);
    }
    ...
    public AndroidMemoryReadingOrBuilder getAndroidMemoryReadingsOrBuilder(int n3) {
        return (AndroidMemoryReadingOrBuilder)this.androidMemoryReadings_.get(n3);
    }
    ...
    public CpuMetricReading getCpuMetricReadings(int n3) {
        return (CpuMetricReading)this.cpuMetricReadings_.get(n3);
    }
    ...
    public CpuMetricReadingOrBuilder getCpuMetricReadingsOrBuilder(int n3) {
        return (CpuMetricReadingOrBuilder)this.cpuMetricReadings_.get(n3);
    }
