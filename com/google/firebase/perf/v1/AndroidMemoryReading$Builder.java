...
implements AndroidMemoryReadingOrBuilder {
    ...
    public AndroidMemoryReading$Builder setClientTimeUs(long l2) {
        this.copyOnWrite();
        AndroidMemoryReading.access$100((AndroidMemoryReading)this.instance, l2);
        return this;
    }

    public AndroidMemoryReading$Builder setUsedAppJavaHeapMemoryKb(int n3) {
        this.copyOnWrite();
        AndroidMemoryReading.access$300((AndroidMemoryReading)this.instance, n3);
        return this;
    }
}
