...
implements GaugeMetadataOrBuilder {
    ...
    public GaugeMetadata$Builder setCpuClockRateKhz(int n3) {
        this.copyOnWrite();
        GaugeMetadata.access$400((GaugeMetadata)this.instance, n3);
        return this;
    }

    public GaugeMetadata$Builder setCpuProcessorCount(int n3) {
        this.copyOnWrite();
        GaugeMetadata.access$600((GaugeMetadata)this.instance, n3);
        return this;
    }

    public GaugeMetadata$Builder setDeviceRamSizeKb(int n3) {
        this.copyOnWrite();
        GaugeMetadata.access$800((GaugeMetadata)this.instance, n3);
        return this;
    }

    public GaugeMetadata$Builder setMaxAppJavaHeapMemoryKb(int n3) {
        this.copyOnWrite();
        GaugeMetadata.access$1000((GaugeMetadata)this.instance, n3);
        return this;
    }

    public GaugeMetadata$Builder setMaxEncouragedAppJavaHeapMemoryKb(int n3) {
        this.copyOnWrite();
        GaugeMetadata.access$1200((GaugeMetadata)this.instance, n3);
        return this;
    }
