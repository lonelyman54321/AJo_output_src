...
implements PerfSessionOrBuilder {
    ...
    public SessionVerbosity getSessionVerbosity(int n3) {
        return ((PerfSession)this.instance).getSessionVerbosity(n3);
    }
    ...
    public PerfSession$Builder setSessionVerbosity(int n3, SessionVerbosity sessionVerbosity) {
        this.copyOnWrite();
        PerfSession.access$400((PerfSession)this.instance, n3, sessionVerbosity);
        return this;
    }
}
