...
implements CpuMetricReadingOrBuilder {
    ...
    public CpuMetricReading$Builder setClientTimeUs(long l2) {
        this.copyOnWrite();
        CpuMetricReading.access$100((CpuMetricReading)this.instance, l2);
        return this;
    }

    public CpuMetricReading$Builder setSystemTimeUs(long l2) {
        this.copyOnWrite();
        CpuMetricReading.access$500((CpuMetricReading)this.instance, l2);
        return this;
    }

    public CpuMetricReading$Builder setUserTimeUs(long l2) {
        this.copyOnWrite();
        CpuMetricReading.access$300((CpuMetricReading)this.instance, l2);
        return this;
    }
}
