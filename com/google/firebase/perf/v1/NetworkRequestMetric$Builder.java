...
implements NetworkRequestMetricOrBuilder {
    ...
    public NetworkRequestMetric$Builder addPerfSessions(int n3, PerfSession$Builder perfSessionOrBuilder) {
        this.copyOnWrite();
        ...
        NetworkRequestMetric.access$2800(networkRequestMetric, n3, (PerfSession)perfSessionOrBuilder);
        return this;
    }

    public NetworkRequestMetric$Builder addPerfSessions(int n3, PerfSession perfSession) {
        this.copyOnWrite();
        NetworkRequestMetric.access$2800((NetworkRequestMetric)this.instance, n3, perfSession);
        return this;
    }
    ...
    public String getCustomAttributesOrDefault(String string2, String string3) {
        string2.getClass();
        Map map2 = ((NetworkRequestMetric)this.instance).getCustomAttributesMap();
    ...
    public PerfSession getPerfSessions(int n3) {
        return ((NetworkRequestMetric)this.instance).getPerfSessions(n3);
    }
    ...
    public NetworkRequestMetric$Builder putAllCustomAttributes(Map map2) {
        this.copyOnWrite();
        NetworkRequestMetric.access$2500((NetworkRequestMetric)this.instance).putAll(map2);
        return this;
    }
    ...
    public NetworkRequestMetric$Builder removePerfSessions(int n3) {
        this.copyOnWrite();
        NetworkRequestMetric.access$3100((NetworkRequestMetric)this.instance, n3);
        return this;
    }

    public NetworkRequestMetric$Builder setClientStartTimeUs(long l2) {
        this.copyOnWrite();
        NetworkRequestMetric.access$1700((NetworkRequestMetric)this.instance, l2);
        return this;
    }
    ...
    public NetworkRequestMetric$Builder setHttpResponseCode(int n3) {
        this.copyOnWrite();
        NetworkRequestMetric.access$1200((NetworkRequestMetric)this.instance, n3);
        return this;
    }
    ...
    public NetworkRequestMetric$Builder setPerfSessions(int n3, PerfSession$Builder perfSessionOrBuilder) {
        this.copyOnWrite();
        NetworkRequestMetric networkRequestMetric = (NetworkRequestMetric)this.instance;
        perfSessionOrBuilder = (PerfSession)perfSessionOrBuilder.build();
        NetworkRequestMetric.access$2600(networkRequestMetric, n3, (PerfSession)perfSessionOrBuilder);
        return this;
    }

    public NetworkRequestMetric$Builder setPerfSessions(int n3, PerfSession perfSession) {
        this.copyOnWrite();
        NetworkRequestMetric.access$2600((NetworkRequestMetric)this.instance, n3, perfSession);
        return this;
    }

    public NetworkRequestMetric$Builder setRequestPayloadBytes(long l2) {
        this.copyOnWrite();
        NetworkRequestMetric.access$600((NetworkRequestMetric)this.instance, l2);
        return this;
    }
    ...
    public NetworkRequestMetric$Builder setResponsePayloadBytes(long l2) {
        this.copyOnWrite();
        NetworkRequestMetric.access$800((NetworkRequestMetric)this.instance, l2);
        return this;
    }

    public NetworkRequestMetric$Builder setTimeToRequestCompletedUs(long l2) {
        this.copyOnWrite();
        NetworkRequestMetric.access$1900((NetworkRequestMetric)this.instance, l2);
        return this;
    }

    public NetworkRequestMetric$Builder setTimeToResponseCompletedUs(long l2) {
        this.copyOnWrite();
        NetworkRequestMetric.access$2300((NetworkRequestMetric)this.instance, l2);
        return this;
    }

    public NetworkRequestMetric$Builder setTimeToResponseInitiatedUs(long l2) {
        this.copyOnWrite();
        NetworkRequestMetric.access$2100((NetworkRequestMetric)this.instance, l2);
        return this;
    }
