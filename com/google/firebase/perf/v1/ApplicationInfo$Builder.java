...
implements ApplicationInfoOrBuilder {
    ...
    public String getCustomAttributesOrDefault(String string2, String string3) {
        string2.getClass();
        Map map2 = ((ApplicationInfo)this.instance).getCustomAttributesMap();
    ...
    public ApplicationInfo$Builder putAllCustomAttributes(Map map2) {
        this.copyOnWrite();
        ApplicationInfo.access$1200((ApplicationInfo)this.instance).putAll(map2);
        return this;
    }
