...
implements DelegatingScheduledFuture$Resolver {
    ...
    public /* synthetic */ i(DelegatingScheduledExecutorService delegatingScheduledExecutorService, Runnable runnable2, long l2, long l3, TimeUnit timeUnit) {
    ...
    public final ScheduledFuture addCompleter(DelegatingScheduledFuture$Completer delegatingScheduledFuture$Completer) {
        ...
        long l3 = this.c;
        return DelegatingScheduledExecutorService.b(delegatingScheduledExecutorService, runnable2, l3, l2, timeUnit, delegatingScheduledFuture$Completer);
    }
}
