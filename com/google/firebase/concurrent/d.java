...
implements Runnable {
    ...
    public /* synthetic */ d(DelegatingScheduledExecutorService delegatingScheduledExecutorService, Runnable runnable2, DelegatingScheduledFuture$Completer delegatingScheduledFuture$Completer) {
    ...
    public final void run() {
        ...
        DelegatingScheduledExecutorService.l(this.a, runnable2, delegatingScheduledFuture$Completer);
    }
}
