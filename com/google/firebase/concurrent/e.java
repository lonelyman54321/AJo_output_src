...
implements Runnable {
    ...
    public /* synthetic */ e(DelegatingScheduledExecutorService delegatingScheduledExecutorService, Runnable runnable2, DelegatingScheduledFuture$Completer delegatingScheduledFuture$Completer) {
    ...
    public final void run() {
        ...
        DelegatingScheduledExecutorService.f(this.a, runnable2, delegatingScheduledFuture$Completer);
    }
}
