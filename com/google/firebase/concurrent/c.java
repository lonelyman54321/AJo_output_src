...
implements Runnable {
    ...
    public /* synthetic */ c(Runnable runnable2, DelegatingScheduledFuture$Completer delegatingScheduledFuture$Completer) {
        this.a = runnable2;
    ...
    public final void run() {
        ...
        DelegatingScheduledExecutorService.i(runnable2, delegatingScheduledFuture$Completer);
    }
}
