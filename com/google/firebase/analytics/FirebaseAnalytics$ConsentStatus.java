...
extends Enum {
    ...
    static {
        ...
        int n3 = 1;
        DENIED = firebaseAnalytics$ConsentStatus = new FirebaseAnalytics$ConsentStatus("DENIED", n3);
        ...
        firebaseAnalytics$ConsentStatusArray[n3] = firebaseAnalytics$ConsentStatus;
