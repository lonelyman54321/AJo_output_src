...
public final class Balloon$showAlignBottom$$inlined$show$1
implements Runnable {
    ...
    public Balloon$showAlignBottom$$inlined$show$1(Balloon balloon2, View view, View[] viewArray, Balloon balloon3, View view2, int n3, int n4) {
        this.a = balloon2;
        this.b = view;
        this.c = viewArray;
        this.d = balloon3;
    ...
    public final void run() {
        ...
        if (object != null) {
            ...
            int n10 = balloon2.n() / 2;
            n8 -= n10;
            n10 = this.f;
            n8 = (n8 + n10) * n4;
            n10 = this.g;
            popupWindow.showAsDropDown((View)object, n8, n10);
        }
    }
}
