...
class CTInAppNativeInterstitialImageFragment$1
implements ViewTreeObserver.OnGlobalLayoutListener {
    public final /* synthetic */ FrameLayout a;
    public final /* synthetic */ CloseImageView b;
    public final /* synthetic */ CTInAppNativeInterstitialImageFragment c;

    public CTInAppNativeInterstitialImageFragment$1(CTInAppNativeInterstitialImageFragment cTInAppNativeInterstitialImageFragment, FrameLayout frameLayout, CloseImageView closeImageView) {
    ...
    public final void onGlobalLayout() {
        ...
        if (bl2 && (bl2 = cTInAppNativeInterstitialImageFragment.Va())) {
            ...
            cTInAppNativeInterstitialImageFragment.Za((RelativeLayout)cTInAppNotification, layoutParams, frameLayout, closeImageView);
        } else {
            bl2 = cTInAppNativeInterstitialImageFragment.Va();
            if (bl2) {
                cTInAppNotification = cTInAppNativeInterstitialImageFragment.j;
                cTInAppNativeInterstitialImageFragment.Ya((RelativeLayout)cTInAppNotification, layoutParams, frameLayout, closeImageView);
            } else {
                int n3;
                cTInAppNotification = cTInAppNativeInterstitialImageFragment.j;
                float f5 = cTInAppNotification.getMeasuredWidth();
                float f6 = 1.78f;
                layoutParams.height = n3 = (int)(f5 *= f6);
