...
extends NativeEvent {
    ...
    public ScheduleEvent(String string2) {
        this(string2, 0L, 2, null);
    }

    public ScheduleEvent(String string2, long l2) {
        super(string2, l2);
        this.userData = string2;
        this.timeStampMillis = l2;
    }

    public /* synthetic */ ScheduleEvent(String string2, long l2, int n3, DefaultConstructorMarker defaultConstructorMarker) {
        int n4 = n3 & 1;
        if (n4 != 0) {
            string2 = null;
        }
