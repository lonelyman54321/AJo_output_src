...
public final class ConvertedOfferEvent
extends BaseSubscriptionEvent {
    private final String subtype;
    private final String type;

    public ConvertedOfferEvent() {
        this(null, null, 3, null);
    }

    public ConvertedOfferEvent(JSONObject jSONObject) {
        this(jSONObject, null, 2, null);
    }

    public ConvertedOfferEvent(JSONObject object, String string2) {
        super((JSONObject)object, string2);
        object = SubscriptionEventName.AFFISE_SUBSCRIPTION_FIRST_CONVERSION.getEventName();
        this.type = object;
        object = SubscriptionSubType.AFFISE_SUB_CONVERTED_OFFER.getTypeName();
        this.subtype = object;
    }

    public /* synthetic */ ConvertedOfferEvent(JSONObject jSONObject, String string2, int n3, DefaultConstructorMarker defaultConstructorMarker) {
        int n4 = n3 & 1;
        if (n4 != 0) {
            jSONObject = null;
        }
