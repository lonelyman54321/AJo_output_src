...
public final class SubscriptionInRetryEvent
extends BaseSubscriptionEvent {
    private final String subtype;
    private final String type;

    public SubscriptionInRetryEvent() {
        this(null, null, 3, null);
    }

    public SubscriptionInRetryEvent(JSONObject jSONObject) {
        this(jSONObject, null, 2, null);
    }

    public SubscriptionInRetryEvent(JSONObject object, String string2) {
        super((JSONObject)object, string2);
        object = SubscriptionEventName.AFFISE_SUBSCRIPTION_ENTERED_BILLING_RETRY.getEventName();
        this.type = object;
        object = SubscriptionSubType.AFFISE_SUB_SUBSCRIPTION_IN_RETRY.getTypeName();
        this.subtype = object;
    }

    public /* synthetic */ SubscriptionInRetryEvent(JSONObject jSONObject, String string2, int n3, DefaultConstructorMarker defaultConstructorMarker) {
        int n4 = n3 & 1;
        if (n4 != 0) {
            jSONObject = null;
        }
