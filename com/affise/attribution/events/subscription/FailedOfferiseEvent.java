...
public final class FailedOfferiseEvent
extends BaseSubscriptionEvent {
    private final String subtype;
    private final String type;

    public FailedOfferiseEvent(JSONObject jSONObject) {
        Intrinsics.checkNotNullParameter(jSONObject, "data");
        this(jSONObject, null, 2, null);
    }

    public FailedOfferiseEvent(JSONObject object, String string2) {
        ...
        this.type = object;
        object = SubscriptionSubType.AFFISE_SUB_FAILED_OFFERISE.getTypeName();
        this.subtype = object;
    }

    public /* synthetic */ FailedOfferiseEvent(JSONObject jSONObject, String string2, int n3, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n3 &= 2) != 0) {
            string2 = null;
        }
