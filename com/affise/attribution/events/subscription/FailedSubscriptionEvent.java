...
public final class FailedSubscriptionEvent
extends BaseSubscriptionEvent {
    private final String subtype;
    private final String type;

    public FailedSubscriptionEvent() {
        this(null, null, 3, null);
    }

    public FailedSubscriptionEvent(JSONObject jSONObject) {
        this(jSONObject, null, 2, null);
    }

    public FailedSubscriptionEvent(JSONObject object, String string2) {
        super((JSONObject)object, string2);
        object = SubscriptionEventName.AFFISE_SUBSCRIPTION_CANCELLATION.getEventName();
        this.type = object;
        object = SubscriptionSubType.AFFISE_SUB_FAILED_SUBSCRIPTION.getTypeName();
        this.subtype = object;
    }

    public /* synthetic */ FailedSubscriptionEvent(JSONObject jSONObject, String string2, int n3, DefaultConstructorMarker defaultConstructorMarker) {
        int n4 = n3 & 1;
        if (n4 != 0) {
            jSONObject = null;
        }
