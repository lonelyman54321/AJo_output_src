...
public final class ConvertedTrialFromRetryEvent
extends BaseSubscriptionEvent {
    private final String subtype;
    private final String type;

    public ConvertedTrialFromRetryEvent() {
        this(null, null, 3, null);
    }

    public ConvertedTrialFromRetryEvent(JSONObject jSONObject) {
        this(jSONObject, null, 2, null);
    }

    public ConvertedTrialFromRetryEvent(JSONObject object, String string2) {
        super((JSONObject)object, string2);
        object = SubscriptionEventName.AFFISE_SUBSCRIPTION_RENEWAL_FROM_BILLING_RETRY.getEventName();
        this.type = object;
        object = SubscriptionSubType.AFFISE_SUB_CONVERTED_TRIAL_FROM_RETRY.getTypeName();
        this.subtype = object;
    }

    public /* synthetic */ ConvertedTrialFromRetryEvent(JSONObject jSONObject, String string2, int n3, DefaultConstructorMarker defaultConstructorMarker) {
        int n4 = n3 & 1;
        if (n4 != 0) {
            jSONObject = null;
        }
