...
public final class ReferrerClickTimestampServerProvider
extends LongPropertyProvider {
    private final ProviderType key;
    private final float order;
    private final StoreInstallReferrerUseCase useCase;

    public ReferrerClickTimestampServerProvider(StoreInstallReferrerUseCase object) {
        Intrinsics.checkNotNullParameter(object, "useCase");
        this.useCase = object;
        this.order = 16.0f;
        object = ProviderType.REFERRER_CLICK_TIME_SERVER;
        this.key = object;
    }
    ...
    public Long provide() {
        ...
        Object object2 = null;
        if (object != null && (l7 = (l4 = (l3 = ((Number)(object = Long.valueOf(((AffiseReferrerData)object).getReferrerClickTimestampServerSeconds()))).longValue()) - (l2 = 0L)) == 0L ? 0 : (l4 < 0L ? -1 : 1)) != false) {
            object2 = object;
        }
        return object2;
    }
