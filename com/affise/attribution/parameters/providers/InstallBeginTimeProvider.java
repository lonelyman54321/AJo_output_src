...
extends LongPropertyProvider {
    ...
    public Long provide() {
        ...
        Object object2 = null;
        if (object != null && (l7 = (l4 = (l3 = ((Number)(object = Long.valueOf(((AffiseReferrerData)object).getInstallBeginTimestampSeconds()))).longValue()) - (l2 = 0L)) == 0L ? 0 : (l4 < 0L ? -1 : 1)) != false) {
            object2 = object;
        }
        return object2;
    }
