...
extends a {
    ...
    public RemoveFromCartEvent(RemoveFromCartEvent object) {
        super((a)object);
        CopyOnWriteArrayList copyOnWriteArrayList = new CopyOnWriteArrayList();
        this.cartProductList = copyOnWriteArrayList;
        super();
        this.currency = copyOnWriteArrayList;
        copyOnWriteArrayList = ((RemoveFromCartEvent)object).cartProductList;
        this.setCartProductList(copyOnWriteArrayList);
        object = (Currency)((RemoveFromCartEvent)object).currency.get();
        this.setCurrency((Currency)object);
    }

    public RemoveFromCartEvent(Iterable iterable) {
    ...
    public RemoveFromCartEvent(Currency currency, Iterable iterable) {
        Serializable serializable;
        this.cartProductList = serializable = new Serializable();
        this.currency = serializable;
        this.setCartProductList(iterable);
    ...
    public RemoveFromCartEvent(CartProduct ... object) {
        Serializable serializable;
        this.cartProductList = serializable = new Serializable();
        this.currency = serializable;
