...
extends a {
    ...
    public AddToCartEvent(AddToCartEvent object) {
        super((a)object);
        CopyOnWriteArrayList copyOnWriteArrayList = new CopyOnWriteArrayList();
        this.cartProductList = copyOnWriteArrayList;
        super();
        this.currency = copyOnWriteArrayList;
        copyOnWriteArrayList = ((AddToCartEvent)object).cartProductList;
        this.setCartProductList(copyOnWriteArrayList);
        object = (Currency)((AddToCartEvent)object).currency.get();
        this.setCurrency((Currency)object);
    }

    public AddToCartEvent(Iterable iterable) {
    ...
    public AddToCartEvent(Currency currency, Iterable iterable) {
        Serializable serializable;
        this.cartProductList = serializable = new Serializable();
        this.currency = serializable;
        this.setCartProductList(iterable);
    ...
    public AddToCartEvent(CartProduct ... object) {
        Serializable serializable;
        this.cartProductList = serializable = new Serializable();
        this.currency = serializable;
