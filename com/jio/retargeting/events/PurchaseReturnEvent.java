...
extends a {
    ...
    public PurchaseReturnEvent(PurchaseReturnEvent object) {
        super((a)object);
        ...
        serializable = ((PurchaseReturnEvent)object).cartProductList;
        this.setCartProductList((Iterable)((Object)serializable));
        serializable = (Currency)((PurchaseReturnEvent)object).currency.get();
        this.setCurrency((Currency)serializable);
        object = (String)((PurchaseReturnEvent)object).transactionId.get();
        this.setTransactionId((String)object);
    }

    public PurchaseReturnEvent(Iterable iterable) {
    ...
    public PurchaseReturnEvent(Currency currency, Iterable iterable, String string2) {
        Serializable serializable;
        this.cartProductList = serializable = new Serializable();
        this.currency = serializable;
        super();
    ...
    public PurchaseReturnEvent(CartProduct ... object) {
        Serializable serializable;
        this.cartProductList = serializable = new Serializable();
        this.currency = serializable;
        super();
