...
extends a {
    ...
    public ProductViewEvent(ProductViewEvent object) {
        super((a)object);
        ...
        object2 = ((ProductViewEvent)object).cartProductList;
        this.setCartProductList((Iterable)object2);
        object2 = (Currency)((ProductViewEvent)object).currency.get();
        this.setCurrency((Currency)object2);
        object2 = (String)((ProductViewEvent)object).startTime.get();
        this.setStartTime((String)object2);
        object = (String)((ProductViewEvent)object).endTime.get();
        this.setEndTime((String)object);
    }

    public ProductViewEvent(Iterable iterable) {
    ...
    public ProductViewEvent(Currency currency, Iterable iterable, String string2, String string3) {
        Serializable serializable;
        this.cartProductList = serializable = new Serializable();
        this.currency = serializable;
        super();
    ...
    public ProductViewEvent(CartProduct ... object) {
        Serializable serializable;
        this.cartProductList = serializable = new Serializable();
        this.currency = serializable;
        super();
