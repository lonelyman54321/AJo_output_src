...
extends a {
    ...
    public PurchaseCompleteEvent(PurchaseCompleteEvent object) {
        super((a)object);
        ...
        serializable = ((PurchaseCompleteEvent)object).cartProductList;
        this.setCartProductList((Iterable)((Object)serializable));
        serializable = (Currency)((PurchaseCompleteEvent)object).currency.get();
        this.setCurrency((Currency)serializable);
        object = (String)((PurchaseCompleteEvent)object).transactionId.get();
        this.setTransactionId((String)object);
    }

    public PurchaseCompleteEvent(Iterable iterable) {
    ...
    public PurchaseCompleteEvent(Currency currency, Iterable iterable, String string2) {
        Serializable serializable;
        this.cartProductList = serializable = new Serializable();
        this.currency = serializable;
        super();
    ...
    public PurchaseCompleteEvent(CartProduct ... object) {
        Serializable serializable;
        this.cartProductList = serializable = new Serializable();
        this.currency = serializable;
        super();
