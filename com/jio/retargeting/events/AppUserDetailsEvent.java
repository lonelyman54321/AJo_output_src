...
public class AppUserDetailsEvent
extends a {
    ...
    public AppUserDetailsEvent(AppUserDetailsEvent object) {
        super((a)object);
        CopyOnWriteArrayList copyOnWriteArrayList;
        this.customerDetailsList = copyOnWriteArrayList = new CopyOnWriteArrayList();
        object = ((AppUserDetailsEvent)object).getCustomerDetailsList();
        this.setCustomerDetailsList((Iterable)object);
    }

    public AppUserDetailsEvent(Iterable iterable) {
        CopyOnWriteArrayList copyOnWriteArrayList;
        this.customerDetailsList = copyOnWriteArrayList = new CopyOnWriteArrayList();
        this.setCustomerDetailsList(iterable);
    }

    public AppUserDetailsEvent(CustomerDetails ... object) {
        List list;
