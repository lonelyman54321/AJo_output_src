...
import com.jio.jioads.utils.Constants$AdRequestParameterKeys$Companion;

public interface Constants$AdRequestParameterKeys {
    public static final String ADREQS = "adreqs";
    ...
    public static final String APZ = "apz";
    public static final String BANNER_SIZE = "bz";
    public static final String CB_STRING = "cb";
    ...
    public static final Constants$AdRequestParameterKeys$Companion Companion = Constants$AdRequestParameterKeys$Companion.a;
    public static final String DEFAULT_CGI = "defaultCGI";
    ...
    public static final String INCLUDE_AD_FORMATS = "iaf";
    ...
    public static final String MOL_IMPRESSION_ID = "mol_impression_id";
    ...
    public static final String SUPPORTED_MAXIMUM_BANNER_SIZE = "xbz";
    public static final String TE = "te";
    public static final String TIME_ZONE = "tz";
    public static final String TV = "tv";
    public static final String UE = "ue";
    public static final String UE_URL = "urls";
