...
import com.ril.ajio.data.repo.AddressRepo$getAddressesNew$$inlined$map$1$2$1;
import com.ril.ajio.data.repo.DataCallback;
import com.ril.ajio.services.data.Address.CartDeliveryAddressInfo;
import kotlin.Unit;

public final class AddressRepo$getAddressesNew$$inlined$map$1$2
implements fs0_2 {
    final /* synthetic */ String $requestID$inlined;
    final /* synthetic */ fs0_2 $this_unsafeFlow;
    final /* synthetic */ AddressRepo this$0;

    public AddressRepo$getAddressesNew$$inlined$map$1$2(fs0_2 fs0_22, AddressRepo addressRepo, String string2) {
    ...
    public final Object emit(Object var1_1, f80_0 var2_2) {
        var3_3 = var2_2 instanceof AddressRepo$getAddressesNew$$inlined$map$1$2$1;
        if (!var3_3) ** GOTO lbl-1000
        var4_4 = var2_2;
        var4_4 = (AddressRepo$getAddressesNew$$inlined$map$1$2$1)var2_2;
        var5_5 = var4_4.label;
        var6_6 = -1 << -1;
        ...
        {
            var4_4 = new AddressRepo$getAddressesNew$$inlined$map$1$2$1(this, (f80_0)var2_2);
        }
