...
final class CcApiRepo$getCCSelectedEntryStatus$1
extends qg3_2
implements Function2 {
    ...
    public CcApiRepo$getCCSelectedEntryStatus$1(CcApiRepo ccApiRepo, Ref$ObjectRef ref$ObjectRef, Map map2, f80_0 f80_02) {
    ...
    public final f80_0 create(Object object, f80_0 f80_02) {
        ...
        CcApiRepo$getCCSelectedEntryStatus$1 ccApiRepo$getCCSelectedEntryStatus$1 = new CcApiRepo$getCCSelectedEntryStatus$1(ccApiRepo, ref$ObjectRef, map2, f80_02);
        ccApiRepo$getCCSelectedEntryStatus$1.L$0 = object;
        return ccApiRepo$getCCSelectedEntryStatus$1;
    }

    public final Object invoke(fs0_2 object, f80_0 object2) {
        object = (CcApiRepo$getCCSelectedEntryStatus$1)this.create(object, (f80_0)object2);
        object2 = Unit.a;
        return ((CcApiRepo$getCCSelectedEntryStatus$1)object).invokeSuspend(object2);
    }
    ...
    public final Object invokeSuspend(Object object) {
        block5: {
            ...
            block6: {
                ...
                this.L$0 = object2;
                this.label = n3;
                String string5 = "cc_item_status";
                object = ccApi.getCCSelectedEntryStatus((String)object3, string2, string3, string4, string5, map2, this);
                if (object == j90_02) {
                    return j90_02;
                }
            }
