...
final class LoginRepository$registerAndLogin$1
extends qg3_2
implements Function2 {
    ...
    public LoginRepository$registerAndLogin$1(LoginRepository loginRepository, String string2, Map map2, String string3, QueryCustomer queryCustomer, String string4, f80_0 f80_02) {
    ...
    public final f80_0 create(Object object, f80_0 f80_02) {
        ...
        LoginRepository$registerAndLogin$1 loginRepository$registerAndLogin$1 = new LoginRepository$registerAndLogin$1(loginRepository, string2, map2, string3, queryCustomer, string4, f80_02);
        loginRepository$registerAndLogin$1.L$0 = object;
        return loginRepository$registerAndLogin$1;
    }

    public final Object invoke(fs0_2 object, f80_0 object2) {
        object = (LoginRepository$registerAndLogin$1)this.create(object, (f80_0)object2);
        object2 = Unit.a;
        return ((LoginRepository$registerAndLogin$1)object).invokeSuspend(object2);
    }
    ...
    public final Object invokeSuspend(Object object) {
        ...
        Object object7;
        Object object8;
        LoginRepository$registerAndLogin$1 loginRepository$registerAndLogin$1 = this;
        ...
        if (n3 != 0) {
            ...
            object6 = object5;
            object5 = "Android";
            object8 = LoginApi$DefaultImpls.registerAndLogin$default((LoginApi)object8, (String)object2, (String)object6, (String)object5, (String)object4, (Map)object3, string2, null, this, n10, null);
            if (object8 == j90_02) {
                return j90_02;
            }
        }
        ...
        if (object8 != null && (bl2 = ((cl2_2)object6).d())) {
            ...
            if (object5 != null && (n14 = ((String)object5).length()) != 0 && (object5 = ((UserInformationModel)object8).getRefresh_token()) != null && (n14 = ((String)object5).length()) != 0) {
                object5 = loginRepository$registerAndLogin$1.$queryCustomer.getLogin();
                ((User)object6).setUid((String)object5);
                ((User)object6).setSuspiciousUserAskForLogin(false);
                object2 = loginRepository$registerAndLogin$1.this$0;
                object5 = loginRepository$registerAndLogin$1.$queryCustomer.getLogin();
                object4 = loginRepository$registerAndLogin$1.$queryCustomer.getLoginvia();
            ...
            loginRepository$registerAndLogin$1.L$0 = null;
            loginRepository$registerAndLogin$1.label = n7;
            object8 = object7.emit(object8, loginRepository$registerAndLogin$1);
        ...
        object6 = object8;
        object2 = loginRepository$registerAndLogin$1.this$0;
        object4 = loginRepository$registerAndLogin$1.$requestID;
        boolean bl3 = true;
        string2 = loginRepository$registerAndLogin$1.$screenName;
        ...
        loginRepository$registerAndLogin$1.L$0 = null;
        loginRepository$registerAndLogin$1.label = n4;
        object8 = object7.emit(object8, loginRepository$registerAndLogin$1);
        if (object8 != j90_02) return Unit.a;
        return j90_02;
    }
