...
final class LoginRepository$sendOtp$2
extends qg3_2
implements gx0_2 {
    ...
    public LoginRepository$sendOtp$2(LoginRepository loginRepository, String string2, String string3, f80_0 f80_02) {
    ...
    public final Object invoke(fs0_2 object, Throwable throwable, f80_0 f80_02) {
        ...
        LoginRepository$sendOtp$2 loginRepository$sendOtp$2 = new LoginRepository$sendOtp$2(loginRepository, string2, string3, f80_02);
        loginRepository$sendOtp$2.L$0 = object;
        loginRepository$sendOtp$2.L$1 = throwable;
        object = Unit.a;
        return loginRepository$sendOtp$2.invokeSuspend(object);
    }
