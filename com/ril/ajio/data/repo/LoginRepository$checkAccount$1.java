...
final class LoginRepository$checkAccount$1
extends qg3_2
implements Function2 {
    ...
    public LoginRepository$checkAccount$1(LoginRepository loginRepository, String string2, Map map2, String string3, String string4, f80_0 f80_02) {
    ...
    public final f80_0 create(Object object, f80_0 f80_02) {
        ...
        LoginRepository$checkAccount$1 loginRepository$checkAccount$1 = new LoginRepository$checkAccount$1(loginRepository, string2, map2, string3, string4, f80_02);
        loginRepository$checkAccount$1.L$0 = object;
        return loginRepository$checkAccount$1;
    }

    public final Object invoke(fs0_2 object, f80_0 object2) {
        object = (LoginRepository$checkAccount$1)this.create(object, (f80_0)object2);
        object2 = Unit.a;
        return ((LoginRepository$checkAccount$1)object).invokeSuspend(object2);
    }
    ...
    public final Object invokeSuspend(Object object) {
        ...
        Object object6;
        Object object7;
        LoginRepository$checkAccount$1 loginRepository$checkAccount$1 = this;
        ...
        if (n3 != 0) {
            ...
            object5 = object4;
            object4 = "Android";
            object7 = LoginApi$DefaultImpls.checkAccount$default((LoginApi)object7, (String)objectArray, (String)object5, (String)object4, (String)object3, (Map)object2, string2, null, this, n10, null);
            if (object7 == j90_02) {
                return j90_02;
            }
        }
        ...
        object7 = (AccountCheckResponse)((dl2_2)object4).b;
        objectArray = ((dl2_2)object4).a;
        boolean bl2 = objectArray.d();
        if (bl2 && object7 != null) {
            LoginRepository.access$checkForExistingUser(loginRepository$checkAccount$1.this$0, (AccountCheckResponse)object7);
            objectArray = DataCallback.Companion;
            object7 = objectArray.onSuccess(object7);
            loginRepository$checkAccount$1.L$0 = null;
            loginRepository$checkAccount$1.label = n7;
            object7 = object6.emit(object7, loginRepository$checkAccount$1);
        ...
        object5 = object7;
        objectArray = loginRepository$checkAccount$1.this$0;
        object3 = loginRepository$checkAccount$1.$requestID;
        boolean bl3 = true;
        string2 = loginRepository$checkAccount$1.$screenName;
        ...
        loginRepository$checkAccount$1.L$0 = null;
        loginRepository$checkAccount$1.label = n4;
        object7 = object6.emit(object7, loginRepository$checkAccount$1);
        if (object7 != j90_02) return Unit.a;
        return j90_02;
    }
