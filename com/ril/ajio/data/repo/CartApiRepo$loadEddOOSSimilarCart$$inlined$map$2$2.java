...
import com.ril.ajio.data.repo.CartApiRepo$loadEddOOSSimilarCart$$inlined$map$2$2$1;
import com.ril.ajio.data.repo.DataCallback;
import com.ril.ajio.services.data.Product.SimilarProductOOSInfo;
import kotlin.Unit;

public final class CartApiRepo$loadEddOOSSimilarCart$$inlined$map$2$2
implements fs0_2 {
    final /* synthetic */ String $screenName$inlined;
    final /* synthetic */ fs0_2 $this_unsafeFlow;

    public CartApiRepo$loadEddOOSSimilarCart$$inlined$map$2$2(fs0_2 fs0_22, String string2) {
    ...
    public final Object emit(Object var1_1, f80_0 var2_2) {
        var3_3 = var2_2 instanceof CartApiRepo$loadEddOOSSimilarCart$$inlined$map$2$2$1;
        if (!var3_3) ** GOTO lbl-1000
        var4_4 = var2_2;
        var4_4 = (CartApiRepo$loadEddOOSSimilarCart$$inlined$map$2$2$1)var2_2;
        var5_5 = var4_4.label;
        var6_6 = -1 << -1;
        ...
        {
            var4_4 = new CartApiRepo$loadEddOOSSimilarCart$$inlined$map$2$2$1(this, (f80_0)var2_2);
        }
