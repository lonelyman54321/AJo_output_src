...
import com.ril.ajio.data.repo.CouponRepo$getSortedListsOfCoupons$$inlined$map$1$2$1;
import com.ril.ajio.data.repo.DataCallback;
import com.ril.ajio.services.data.Cart.CouponList;
import kotlin.Unit;

public final class CouponRepo$getSortedListsOfCoupons$$inlined$map$1$2
implements fs0_2 {
    final /* synthetic */ String $screenName$inlined;
    final /* synthetic */ fs0_2 $this_unsafeFlow;

    public CouponRepo$getSortedListsOfCoupons$$inlined$map$1$2(fs0_2 fs0_22, String string2) {
    ...
    public final Object emit(Object var1_1, f80_0 var2_2) {
        var3_3 = var2_2 instanceof CouponRepo$getSortedListsOfCoupons$$inlined$map$1$2$1;
        if (!var3_3) ** GOTO lbl-1000
        var4_4 = var2_2;
        var4_4 = (CouponRepo$getSortedListsOfCoupons$$inlined$map$1$2$1)var2_2;
        var5_5 = var4_4.label;
        var6_6 = -1 << -1;
        ...
        {
            var4_4 = new CouponRepo$getSortedListsOfCoupons$$inlined$map$1$2$1(this, (f80_0)var2_2);
        }
