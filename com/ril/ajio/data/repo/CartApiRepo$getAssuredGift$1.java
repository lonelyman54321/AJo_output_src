...
final class CartApiRepo$getAssuredGift$1
extends qg3_2
implements Function2 {
    ...
    public CartApiRepo$getAssuredGift$1(CartApiRepo cartApiRepo, Ref$ObjectRef ref$ObjectRef, f80_0 f80_02) {
    ...
    public final f80_0 create(Object object, f80_0 f80_02) {
        ...
        CartApiRepo$getAssuredGift$1 cartApiRepo$getAssuredGift$1 = new CartApiRepo$getAssuredGift$1(cartApiRepo, ref$ObjectRef, f80_02);
        cartApiRepo$getAssuredGift$1.L$0 = object;
        return cartApiRepo$getAssuredGift$1;
    }

    public final Object invoke(fs0_2 object, f80_0 object2) {
        object = (CartApiRepo$getAssuredGift$1)this.create(object, (f80_0)object2);
        object2 = Unit.a;
        return ((CartApiRepo$getAssuredGift$1)object).invokeSuspend(object2);
    }
    ...
    public final Object invokeSuspend(Object object) {
        block5: {
            ...
            block6: {
                ...
                String string3 = (String)this.$url.element;
                ...
                this.label = n3;
                string2 = "AJIO";
                object = object.getAssuredGift(string3, string4, string2, this);
                if (object == j90_02) {
                    return j90_02;
                }
            }
