...
public final class LuxeConfig {
    ...
    public LuxeConfig(Boolean bl2, String string2, Integer n3, Integer n4, boolean bl3) {
        this.masterFlag = bl2;
    ...
    public /* synthetic */ LuxeConfig(Boolean object, String object2, Integer object3, Integer n3, boolean bl2, int n4, DefaultConstructorMarker object4) {
        int n7 = n4 & 1;
        Integer n8 = null;
        if (n7 != 0) {
            n7 = 0;
    ...
    public static /* synthetic */ LuxeConfig copy$default(LuxeConfig luxeConfig, Boolean bl2, String object, Integer constable, Integer object2, boolean bl3, int n3, Object object3) {
        int n4 = n3 & 1;
        if (n4 != 0) {
            bl2 = luxeConfig.masterFlag;
        }
        if ((n4 = n3 & 2) != 0) {
            object = luxeConfig.pageUrl;
        }
        object3 = object;
        int n7 = n3 & 4;
        if (n7 != 0) {
            constable = luxeConfig.trendingCategoryVersion;
        }
        Integer n8 = constable;
        n7 = n3 & 8;
        if (n7 != 0) {
            object2 = luxeConfig.searchPageVersion;
        }
        Integer n10 = object2;
        n7 = n3 & 0x10;
        if (n7 != 0) {
            bl3 = luxeConfig.trendingCategoryEnabled;
        }
        object = luxeConfig;
        constable = bl2;
        object2 = object3;
        n4 = (int)(bl3 ? 1 : 0);
        return luxeConfig.copy(bl2, (String)object3, n8, n10, bl3);
    }
    ...
    public final LuxeConfig copy(Boolean bl2, String string2, Integer n3, Integer n4, boolean bl3) {
        LuxeConfig luxeConfig = new LuxeConfig(bl2, string2, n3, n4, bl3);
        return luxeConfig;
    }
    ...
    public boolean equals(Object object) {
        ...
        boolean bl3 = object instanceof LuxeConfig;
        if (!bl3) {
            return false;
        }
        object = (LuxeConfig)object;
        Object object2 = this.masterFlag;
        Object object3 = ((LuxeConfig)object).masterFlag;
        bl3 = Intrinsics.areEqual(object2, object3);
        if (!bl3) {
            return false;
        }
        object2 = this.pageUrl;
        object3 = ((LuxeConfig)object).pageUrl;
        bl3 = Intrinsics.areEqual(object2, object3);
        if (!bl3) {
            return false;
        }
        object2 = this.trendingCategoryVersion;
        object3 = ((LuxeConfig)object).trendingCategoryVersion;
        bl3 = Intrinsics.areEqual(object2, object3);
        if (!bl3) {
            return false;
        }
        object2 = this.searchPageVersion;
        object3 = ((LuxeConfig)object).searchPageVersion;
        bl3 = Intrinsics.areEqual(object2, object3);
        if (!bl3) {
            return false;
        }
        bl3 = this.trendingCategoryEnabled;
        boolean bl4 = ((LuxeConfig)object).trendingCategoryEnabled;
        if (bl3 != bl4) {
            return false;
        }
        return bl2;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("LuxeConfig(masterFlag=");
