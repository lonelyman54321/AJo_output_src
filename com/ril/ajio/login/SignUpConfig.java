...
public final class SignUpConfig {
    ...
    public final boolean equals(Object object) {
        ...
        boolean bl3 = object instanceof SignUpConfig;
        if (!bl3) {
            return false;
        }
        object = (SignUpConfig)object;
        Object object2 = this.a;
        Boolean bl4 = ((SignUpConfig)object).a;
        bl3 = Intrinsics.areEqual(object2, bl4);
        if (!bl3) {
            return false;
        }
        object2 = this.b;
        object = ((SignUpConfig)object).b;
    ...
    public final String toString() {
        Boolean bl2 = this.a;
        String string2 = this.b;
        StringBuilder stringBuilder = new StringBuilder("SignUpConfig(enableBannerSignupPage=");
