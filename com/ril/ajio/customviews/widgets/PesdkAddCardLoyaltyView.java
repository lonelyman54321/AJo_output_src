...
import com.ril.ajio.customviews.widgets.PesdkAddCardLoyaltyView$BankOfferClickableSpan;
import com.ril.ajio.customviews.widgets.PesdkAddCardLoyaltyView$Companion;
import com.ril.ajio.customviews.widgets.PesdkAddCardLoyaltyView$CustomClickableSpan;
import com.ril.ajio.customviews.widgets.PesdkAddCardLoyaltyView$RegisterClickableSpan;
...
public final class PesdkAddCardLoyaltyView
extends FrameLayout
implements View.OnClickListener {
    public static final int $stable = 0;
    public static final PesdkAddCardLoyaltyView$Companion Companion;
    public static final int LOYALTY_VIEW = 1;
    private Typeface boldFont;
    private PesdkAddCardLoyaltyView$AddCardLoyaltyClickListener cardClickListener;
    ...
    static {
        PesdkAddCardLoyaltyView$Companion pesdkAddCardLoyaltyView$Companion;
        Companion = pesdkAddCardLoyaltyView$Companion = new PesdkAddCardLoyaltyView$Companion(null);
        $stable = 8;
    }

    public PesdkAddCardLoyaltyView(Context context) {
        Intrinsics.checkNotNullParameter(context, "context");
        super(context);
        this.initView(context);
    }

    public PesdkAddCardLoyaltyView(Context context, AttributeSet attributeSet) {
        Intrinsics.checkNotNullParameter(context, "context");
        super(context, attributeSet);
        this.initView(context);
    }

    public PesdkAddCardLoyaltyView(Context context, AttributeSet attributeSet, int n3) {
        Intrinsics.checkNotNullParameter(context, "context");
        super(context, attributeSet, n3);
        this.initView(context);
    }

    public PesdkAddCardLoyaltyView(Context context, AttributeSet attributeSet, int n3, int n4) {
        Intrinsics.checkNotNullParameter(context, "context");
        super(context, attributeSet, n3, n4);
        this.initView(context);
    }

    public static final /* synthetic */ PesdkAddCardLoyaltyView$AddCardLoyaltyClickListener access$getCardClickListener$p(PesdkAddCardLoyaltyView pesdkAddCardLoyaltyView) {
        return pesdkAddCardLoyaltyView.cardClickListener;
    }

    public static final /* synthetic */ OfferDetails access$getOfferDetail$p(PesdkAddCardLoyaltyView pesdkAddCardLoyaltyView) {
        return pesdkAddCardLoyaltyView.offerDetail;
    }
    ...
    private final void initView(Context context) {
        ...
        if (bl2) {
            ...
            int n4 = R$layout.pesdk_lux_view_add_card_lr;
            layoutInflater = layoutInflater.inflate(n4, (ViewGroup)this, n3 != 0);
        } else {
            layoutInflater = LayoutInflater.from((Context)context);
            int n7 = R$layout.pesdk_view_add_card_lr;
    ...
    private final void setCollapseLoyaltyView(LpStoredCardBalance object) {
        ...
        if (n7 > 0) {
            ...
            object7 = new PesdkAddCardLoyaltyView$CustomClickableSpan(this);
            object3.setSpan(object7, n16, n7, n15);
            ...
            int n17 = Intrinsics.areEqual(object, object8);
            n4 = 8;
            if (n17 == 0) {
                ...
                if (n4 != 0) {
                    object8 = "REGISTERED";
                    n4 = StringsKt.O((CharSequence)object, (String)object8, 0, false, n10);
                } else {
                    object8 = "registered";
                    n4 = StringsKt.O((CharSequence)object, (String)object8, 0, false, n10);
                }
                object3 = new SpannableStringBuilder((CharSequence)object);
                n17 = n4 + 23;
                n7 = object3.length();
                string2 = this.boldFont;
                object6 = new AjioCustomTypefaceSpan(string6, (Typeface)string2);
                object3.setSpan(object6, n4, n17, n15);
                string2 = this.regularFont;
                object6 = new AjioCustomTypefaceSpan(string6, (Typeface)string2);
                object3.setSpan(object6, n17, n7, n15);
                string2 = this.boldFont;
                object6 = new AjioCustomTypefaceSpan(string6, (Typeface)string2);
                n10 = n7 + -12;
                object3.setSpan(object6, n10, n7, n15);
                object6 = new ForegroundColorSpan(n3);
                object3.setSpan(object6, n4, n17, n14);
                object6 = new ForegroundColorSpan(n3);
                object3.setSpan(object6, n10, n7, n14);
                object2 = new PesdkAddCardLoyaltyView$RegisterClickableSpan(this);
                object3.setSpan(object2, n4, n17, n15);
                object = new PesdkAddCardLoyaltyView$CustomClickableSpan(this);
                object3.setSpan(object, n10, n7, n15);
                object = this.tvLoyaltyPoints;
                if (object == null) {
                    Intrinsics.throwUninitializedPropertyAccessException(string5);
                    n17 = 0;
                ...
                object8 = LinkMovementMethod.getInstance();
                object.setMovementMethod((MovementMethod)object8);
                object = this.tvLoyaltyPoints;
                if (object == null) {
                    Intrinsics.throwUninitializedPropertyAccessException(string5);
                } else {
    ...
    private final void setOfferView(OfferDetails offerDetails, String string2) {
        float f5;
        Object object;
        PesdkAddCardLoyaltyView pesdkAddCardLoyaltyView = this;
        ...
        if (n3 > 0) {
            ...
            if (n3 == 0) {
                ...
                n3 = (int)(og1_1.b() ? 1 : 0);
                n3 = n3 != 0 ? hv3_0.m(R$color.pesdk_lux_color_3) : hv3_0.m(R$color.pesdk_color_3);
                object = pesdkAddCardLoyaltyView.layoutLoyaltyOffer;
                if (object == null) {
                    Intrinsics.throwUninitializedPropertyAccessException(string3);
                    object = null;
                    f5 = 0.0f;
                ...
                string3 = null;
                object.setVisibility(0);
                object = pesdkAddCardLoyaltyView.layoutOffer;
                if (object == null) {
                    Intrinsics.throwUninitializedPropertyAccessException((String)object3);
                    object = null;
                    f5 = 0.0f;
                ...
                object2 = new PesdkAddCardLoyaltyView$BankOfferClickableSpan(pesdkAddCardLoyaltyView);
                object7.setSpan(object2, n8, n4, n10);
                object2 = pesdkAddCardLoyaltyView.tvOffer;
                object = "tvOffer";
                if (object2 == null) {
                ...
                serializable = pesdkAddCardLoyaltyView.tvOffer;
                if (serializable == null) {
                    Intrinsics.throwUninitializedPropertyAccessException((String)object);
                    serializable = null;
                }
        ...
        if ((serializable = pesdkAddCardLoyaltyView.layoutOffer) == null) {
            Intrinsics.throwUninitializedPropertyAccessException((String)object3);
            serializable = null;
        }
        n3 = 8;
        serializable.setVisibility(n3);
        serializable = pesdkAddCardLoyaltyView.lpStoredCardBalance;
        if (serializable == null) {
            serializable = pesdkAddCardLoyaltyView.layoutLoyaltyOffer;
            if (serializable == null) {
                Intrinsics.throwUninitializedPropertyAccessException(string3);
            } else {
                serializable2 = serializable;
    ...
    public final void setCardClickListener(PesdkAddCardLoyaltyView$AddCardLoyaltyClickListener pesdkAddCardLoyaltyView$AddCardLoyaltyClickListener) {
        Intrinsics.checkNotNullParameter(pesdkAddCardLoyaltyView$AddCardLoyaltyClickListener, "clickListener");
        this.cardClickListener = pesdkAddCardLoyaltyView$AddCardLoyaltyClickListener;
    }
    ...
    public final void setData(LpStoredCardBalance object, OfferDetails offerDetails, int n3, String string2) {
        ...
        block12: {
            ...
            block11: {
                ...
                if (n7 > 0 || (n7 = (int)(Intrinsics.areEqual(object2 = ((LpStoredCardBalance)object).getMobileNumberRegistered(), bl2 = Boolean.TRUE) ? 1 : 0)) == 0) break block12;
            }
