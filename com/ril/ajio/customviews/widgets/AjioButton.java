...
public class AjioButton
extends AppCompatButton
implements CustomTextViewImpl {
    public AjioButton(Context context) {
        super(context);
        this.initField(context, null);
    }

    public AjioButton(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.initField(context, attributeSet);
    }

    public AjioButton(Context context, AttributeSet attributeSet, int n3) {
