...
public final class PesdkAddCardLoyaltyView$BankOfferClickableSpan
extends ClickableSpan {
    final /* synthetic */ PesdkAddCardLoyaltyView this$0;

    public PesdkAddCardLoyaltyView$BankOfferClickableSpan(PesdkAddCardLoyaltyView pesdkAddCardLoyaltyView) {
    ...
    public void onClick(View object) {
        ...
        if (object != null) {
            object2 = PesdkAddCardLoyaltyView.access$getOfferDetail$p(this.this$0);
