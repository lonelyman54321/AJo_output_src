...
public class LuxeUnderLineTextView
extends AjioTextView
implements CustomTextViewImpl {
    public LuxeUnderLineTextView(Context context) {
        super(context);
        this.initField(context, null);
    }

    public LuxeUnderLineTextView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.initField(context, attributeSet);
    }

    public LuxeUnderLineTextView(Context context, AttributeSet attributeSet, int n3) {
