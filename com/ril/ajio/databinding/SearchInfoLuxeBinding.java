...
public final class SearchInfoLuxeBinding
implements BC3 {
    ...
    public static SearchInfoLuxeBinding bind(View view) {
        View view2;
        Object object = view;
        int n3 = R$id.no_match_found;
    ...
    public static SearchInfoLuxeBinding inflate(LayoutInflater layoutInflater) {
        return SearchInfoLuxeBinding.inflate(layoutInflater, null, false);
    }

    public static SearchInfoLuxeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.search_info_luxe;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return SearchInfoLuxeBinding.bind((View)layoutInflater);
    }
