...
public final class RowCartSummaryLuxeBinding
implements BC3 {
    ...
    private RowCartSummaryLuxeBinding(LinearLayout linearLayout, ImageView imageView, TextView textView, TextView textView2, LinearLayout linearLayout2, LinearLayout linearLayout3, TextView textView3, TextView textView4, TextView textView5, ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, ConstraintLayout constraintLayout3, ConstraintLayout constraintLayout4, ConstraintLayout constraintLayout5, ConstraintLayout constraintLayout6, TextView textView6, TextView textView7, TextView textView8, TextView textView9, TextView textView10, TextView textView11, TextView textView12, TextView textView13, TextView textView14) {
    ...
    public static RowCartSummaryLuxeBinding bind(View view) {
        View view2;
        Object object = view;
    ...
    public static RowCartSummaryLuxeBinding inflate(LayoutInflater layoutInflater) {
        return RowCartSummaryLuxeBinding.inflate(layoutInflater, null, false);
    }

    public static RowCartSummaryLuxeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.row_cart_summary_luxe;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return RowCartSummaryLuxeBinding.bind((View)layoutInflater);
    }
