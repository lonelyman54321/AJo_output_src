...
public final class LuxeNewRowShopTheLookBinding
implements BC3 {
    ...
    private LuxeNewRowShopTheLookBinding(ConstraintLayout constraintLayout, AjioImageView ajioImageView, AjioTextView ajioTextView, AjioTextView ajioTextView2, AjioTextView ajioTextView3, AjioTextView ajioTextView4, LayoutFreebieGetFreebiesPlpBinding layoutFreebieGetFreebiesPlpBinding, LottieAnimationView lottieAnimationView, LinearLayout linearLayout, AjioTextView ajioTextView5, RelativeLayout relativeLayout, TextView textView, ConstraintLayout constraintLayout2, AjioRoundedCornerImageView ajioRoundedCornerImageView, LayoutSalePriceLuxeBinding layoutSalePriceLuxeBinding) {
    ...
    public static LuxeNewRowShopTheLookBinding bind(View view) {
        View view2;
        Object object = view;
                                        ...
                                        if (view4 != null) {
                                            ...
                                            if (view5 != null) {
                                                ...
                                                if (object10 != null && (view2 = dd2_2.a(n3 = R$id.sale_container, view)) != null) {
                                                    ...
                                                    object = new LuxeNewRowShopTheLookBinding((ConstraintLayout)((Object)object9), (AjioImageView)((Object)object2), (AjioTextView)object3, (AjioTextView)object4, (AjioTextView)object5, (AjioTextView)object6, layoutFreebieGetFreebiesPlpBinding, (LottieAnimationView)((Object)object7), (LinearLayout)view3, (AjioTextView)object8, (RelativeLayout)view4, (TextView)view5, (ConstraintLayout)((Object)object9), (AjioRoundedCornerImageView)((Object)object10), layoutSalePriceLuxeBinding);
                                                    return object;
                                                }
                                            }
                                        }
    ...
    public static LuxeNewRowShopTheLookBinding inflate(LayoutInflater layoutInflater) {
        return LuxeNewRowShopTheLookBinding.inflate(layoutInflater, null, false);
    }

    public static LuxeNewRowShopTheLookBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.luxe_new_row_shop_the_look;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return LuxeNewRowShopTheLookBinding.bind((View)layoutInflater);
    }
