...
public final class ShimmerRatingWishlistBinding
implements BC3 {
    ...
    private ShimmerRatingWishlistBinding(ConstraintLayout constraintLayout, View view, View view2, View view3, View view4, View view5, Barrier barrier, ScaleRatingBar scaleRatingBar) {
    ...
    public static ShimmerRatingWishlistBinding bind(View object) {
        View view;
        View view2;
        View view3;
        View view4;
        ...
        if (view5 != null && (view4 = dd2_2.a(n3 = R$id.row_shimmer_ac_detail_2, object)) != null && (view3 = dd2_2.a(n3 = R$id.row_shimmer_ac_detail_3, object)) != null && (view2 = dd2_2.a(n3 = R$id.row_shimmer_ac_detail_4, object)) != null && (view = dd2_2.a(n3 = R$id.row_shimmer_title, object)) != null) {
            ...
            if (view6 != null) {
                ...
                if (object3 != null) {
                    ShimmerRatingWishlistBinding shimmerRatingWishlistBinding;
                    Object object4 = object;
                    object4 = (ConstraintLayout)((Object)object);
                    object2 = shimmerRatingWishlistBinding;
                    shimmerRatingWishlistBinding = new ShimmerRatingWishlistBinding((ConstraintLayout)((Object)object4), view5, view4, view3, view2, view, (Barrier)view6, (ScaleRatingBar)((Object)object3));
                    return shimmerRatingWishlistBinding;
                }
            }
        }
    ...
    public static ShimmerRatingWishlistBinding inflate(LayoutInflater layoutInflater) {
        return ShimmerRatingWishlistBinding.inflate(layoutInflater, null, false);
    }

    public static ShimmerRatingWishlistBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.shimmer_rating_wishlist;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return ShimmerRatingWishlistBinding.bind((View)layoutInflater);
    }
