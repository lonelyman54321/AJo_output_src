...
public final class RowCartDeliveryAddressBinding
implements BC3 {
    ...
    public static RowCartDeliveryAddressBinding bind(View object) {
        View view;
    ...
    public static RowCartDeliveryAddressBinding inflate(LayoutInflater layoutInflater) {
        return RowCartDeliveryAddressBinding.inflate(layoutInflater, null, false);
    }

    public static RowCartDeliveryAddressBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.row_cart_delivery_address;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return RowCartDeliveryAddressBinding.bind((View)layoutInflater);
    }
