...
public final class RowCartDeliveryAddressLuxeBinding
implements BC3 {
    ...
    public static RowCartDeliveryAddressLuxeBinding bind(View object) {
        View view;
    ...
    public static RowCartDeliveryAddressLuxeBinding inflate(LayoutInflater layoutInflater) {
        return RowCartDeliveryAddressLuxeBinding.inflate(layoutInflater, null, false);
    }

    public static RowCartDeliveryAddressLuxeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.row_cart_delivery_address_luxe;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return RowCartDeliveryAddressLuxeBinding.bind((View)layoutInflater);
    }
