...
public final class LuxeNewRowProductDetailBinding
implements BC3 {
    public final LinearLayout descriptionContainer;
    public final View divider4;
    public final LuxeUnderlineButton moreLessTv;
    ...
    private LuxeNewRowProductDetailBinding(LinearLayout linearLayout, LinearLayout linearLayout2, View view, LuxeUnderlineButton luxeUnderlineButton, LinearLayout linearLayout3, TextView textView, LinearLayout linearLayout4, LinearLayout linearLayout5, RelativeLayout relativeLayout, AjioTextView ajioTextView) {
        this.rootView = linearLayout;
        this.descriptionContainer = linearLayout2;
        this.divider4 = view;
        this.moreLessTv = luxeUnderlineButton;
    ...
    public static LuxeNewRowProductDetailBinding bind(View object) {
        View view;
        View view2;
                    ...
                    if (view5 != null) {
                        ...
                        if (view6 != null) {
                            ...
                            if (view7 != null) {
                                ...
                                if (object4 != null) {
                                    object = new LuxeNewRowProductDetailBinding((LinearLayout)object3, (LinearLayout)view3, view, (LuxeUnderlineButton)object2, (LinearLayout)object3, (TextView)view4, (LinearLayout)view5, (LinearLayout)view6, (RelativeLayout)view7, (AjioTextView)object4);
                                    return object;
                                }
                            }
                        }
    ...
    public static LuxeNewRowProductDetailBinding inflate(LayoutInflater layoutInflater) {
        return LuxeNewRowProductDetailBinding.inflate(layoutInflater, null, false);
    }

    public static LuxeNewRowProductDetailBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.luxe_new_row_product_detail;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return LuxeNewRowProductDetailBinding.bind((View)layoutInflater);
    }
