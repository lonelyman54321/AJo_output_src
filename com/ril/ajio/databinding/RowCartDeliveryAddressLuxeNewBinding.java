...
public final class RowCartDeliveryAddressLuxeNewBinding
implements BC3 {
    ...
    public static RowCartDeliveryAddressLuxeNewBinding bind(View object) {
        View view;
    ...
    public static RowCartDeliveryAddressLuxeNewBinding inflate(LayoutInflater layoutInflater) {
        return RowCartDeliveryAddressLuxeNewBinding.inflate(layoutInflater, null, false);
    }

    public static RowCartDeliveryAddressLuxeNewBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.row_cart_delivery_address_luxe_new;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return RowCartDeliveryAddressLuxeNewBinding.bind((View)layoutInflater);
    }
