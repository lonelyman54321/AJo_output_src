...
import com.ril.ajio.databinding.ImageSearchOldBottomSheetBinding;

public class ImageSearchOldBottomSheetBindingImpl
extends ImageSearchOldBottomSheetBinding {
    ...
    static {
        ...
        n3 = R$id.layout_click_photo_img;
        sparseIntArray.put(n3, 6);
        n3 = R$id.layout_click_photo_title;
        sparseIntArray.put(n3, 7);
        n3 = R$id.layout_upload_photo;
        sparseIntArray.put(n3, 8);
        n3 = R$id.layout_upload_photo_img;
        sparseIntArray.put(n3, 9);
        n3 = R$id.layout_upload_photo_title;
        sparseIntArray.put(n3, 10);
    }

    public ImageSearchOldBottomSheetBindingImpl(ai0_0 ai0_02, View view) {
        Object[] objectArray = sIncludes;
        SparseIntArray sparseIntArray = sViewsWithIds;
        objectArray = ViewDataBinding.mapBindings(ai0_02, view, 11, (ViewDataBinding$h)objectArray, sparseIntArray);
        this(ai0_02, view, objectArray);
    }

    private ImageSearchOldBottomSheetBindingImpl(ai0_0 ai0_02, View view, Object[] objectArray) {
        Object object;
        ...
        object = this;
        super(ai0_02, view, 0, (AppCompatImageView)((Object)object2), (TextView)object3, (TextView)object4, (LinearLayout)object5, (ImageView)object6, (TextView)object7, (ConstraintLayout)((Object)object8), (LinearLayout)object9, (ImageView)object10, (TextView)object11);
        this.mDirtyFlags = -1;
