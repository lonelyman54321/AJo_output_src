...
public final class NewBetterProductDetailCardBinding
implements BC3 {
    ...
    private NewBetterProductDetailCardBinding(ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, ConstraintLayout constraintLayout3, View view, ConstraintLayout constraintLayout4, TextView textView, RecyclerView recyclerView, LinearLayout linearLayout, RelativeLayout relativeLayout, AjioTextView ajioTextView, ImageView imageView, AjioTextView ajioTextView2, RecyclerView recyclerView2, RecyclerView recyclerView3) {
    ...
    public static NewBetterProductDetailCardBinding bind(View view) {
        View view2;
        Object object = view;
                                    ...
                                    if (view7 != null) {
                                        ...
                                        if (object7 != null) {
                                            ...
                                            if (object8 != null) {
                                                ...
                                                if (object9 != null) {
                                                    object = new NewBetterProductDetailCardBinding((ConstraintLayout)((Object)object4), (ConstraintLayout)((Object)object2), (ConstraintLayout)((Object)object3), view3, (ConstraintLayout)((Object)object4), (TextView)view4, (RecyclerView)object5, (LinearLayout)view5, (RelativeLayout)view6, (AjioTextView)object6, (ImageView)view7, (AjioTextView)object7, (RecyclerView)object8, (RecyclerView)object9);
                                                    return object;
                                                }
                                            }
                                        }
    ...
    public static NewBetterProductDetailCardBinding inflate(LayoutInflater layoutInflater) {
        return NewBetterProductDetailCardBinding.inflate(layoutInflater, null, false);
    }

    public static NewBetterProductDetailCardBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.new_better_product_detail_card;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return NewBetterProductDetailCardBinding.bind((View)layoutInflater);
    }
