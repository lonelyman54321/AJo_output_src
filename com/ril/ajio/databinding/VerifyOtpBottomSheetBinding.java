...
public final class VerifyOtpBottomSheetBinding
implements BC3 {
    ...
    public static VerifyOtpBottomSheetBinding bind(View view) {
        View view2;
        Object object = view;
    ...
    public static VerifyOtpBottomSheetBinding inflate(LayoutInflater layoutInflater) {
        return VerifyOtpBottomSheetBinding.inflate(layoutInflater, null, false);
    }

    public static VerifyOtpBottomSheetBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.verify_otp_bottom_sheet;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return VerifyOtpBottomSheetBinding.bind((View)layoutInflater);
    }
