...
public final class RowCartDeliveryAddressNewBinding
implements BC3 {
    ...
    public static RowCartDeliveryAddressNewBinding bind(View object) {
        View view;
    ...
    public static RowCartDeliveryAddressNewBinding inflate(LayoutInflater layoutInflater) {
        return RowCartDeliveryAddressNewBinding.inflate(layoutInflater, null, false);
    }

    public static RowCartDeliveryAddressNewBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.row_cart_delivery_address_new;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return RowCartDeliveryAddressNewBinding.bind((View)layoutInflater);
    }
