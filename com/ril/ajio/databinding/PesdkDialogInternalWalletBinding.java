...
public final class PesdkDialogInternalWalletBinding
implements BC3 {
    ...
    private PesdkDialogInternalWalletBinding(LinearLayout linearLayout, ImageView imageView, AjioTextView ajioTextView, AjioTextView ajioTextView2, AjioTextView ajioTextView3, AjioTextView ajioTextView4, AjioTextView ajioTextView5, AjioTextView ajioTextView6, AjioTextView ajioTextView7, AjioTextView ajioTextView8) {
    ...
    public static PesdkDialogInternalWalletBinding bind(View object) {
        View view;
                                ...
                                if (object7 != null) {
                                    ...
                                    if (object8 != null) {
                                        ...
                                        if (object9 != null) {
                                            ...
                                            PesdkDialogInternalWalletBinding pesdkDialogInternalWalletBinding = new PesdkDialogInternalWalletBinding((LinearLayout)object10, (ImageView)view2, (AjioTextView)object2, (AjioTextView)object3, (AjioTextView)object4, (AjioTextView)object5, (AjioTextView)object6, (AjioTextView)object7, (AjioTextView)object8, (AjioTextView)object9);
                                            return pesdkDialogInternalWalletBinding;
                                        }
                                    }
                                }
                            }
    ...
    public static PesdkDialogInternalWalletBinding inflate(LayoutInflater layoutInflater) {
        return PesdkDialogInternalWalletBinding.inflate(layoutInflater, null, false);
    }

    public static PesdkDialogInternalWalletBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.pesdk_dialog_internal_wallet;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return PesdkDialogInternalWalletBinding.bind((View)layoutInflater);
    }
