...
public final class ViewCheckoutSummaryLuxeBinding
implements BC3 {
    ...
    private ViewCheckoutSummaryLuxeBinding(LinearLayout linearLayout, CheckBox checkBox, RelativeLayout relativeLayout, AjioTextView ajioTextView, AjioTextView ajioTextView2, RowCheckoutOrdersummaryRevampBinding rowCheckoutOrdersummaryRevampBinding) {
    ...
    public static ViewCheckoutSummaryLuxeBinding bind(View object) {
        View view;
            ...
            if (view3 != null) {
                ...
                if (object2 != null) {
                    ...
                    if (object3 != null && (view = dd2_2.a(n3 = R$id.checkout_summary_expandable_layout, object)) != null) {
                        ...
                        ViewCheckoutSummaryLuxeBinding viewCheckoutSummaryLuxeBinding = new ViewCheckoutSummaryLuxeBinding((LinearLayout)object4, (CheckBox)view2, (RelativeLayout)view3, (AjioTextView)object2, (AjioTextView)object3, rowCheckoutOrdersummaryRevampBinding);
                        return viewCheckoutSummaryLuxeBinding;
                    }
                }
            }
        }
    ...
    public static ViewCheckoutSummaryLuxeBinding inflate(LayoutInflater layoutInflater) {
        return ViewCheckoutSummaryLuxeBinding.inflate(layoutInflater, null, false);
    }

    public static ViewCheckoutSummaryLuxeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.view_checkout_summary_luxe;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return ViewCheckoutSummaryLuxeBinding.bind((View)layoutInflater);
    }
