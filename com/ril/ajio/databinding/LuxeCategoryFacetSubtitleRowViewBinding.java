...
public final class LuxeCategoryFacetSubtitleRowViewBinding
implements BC3 {
    ...
    private LuxeCategoryFacetSubtitleRowViewBinding(LinearLayout linearLayout, AjioTextView ajioTextView, ImageView imageView, AjioTextView ajioTextView2, RecyclerView recyclerView, AjioEditText ajioEditText, ImageView imageView2, LinearLayout linearLayout2, LinearLayout linearLayout3, AjioTextView ajioTextView3) {
    ...
    public static LuxeCategoryFacetSubtitleRowViewBinding bind(View object) {
        View view;
                                ...
                                if (view4 != null) {
                                    ...
                                    if (view5 != null) {
                                        ...
                                        if (object6 != null) {
                                            ...
                                            LuxeCategoryFacetSubtitleRowViewBinding luxeCategoryFacetSubtitleRowViewBinding = new LuxeCategoryFacetSubtitleRowViewBinding((LinearLayout)object7, (AjioTextView)object2, (ImageView)view2, (AjioTextView)object3, (RecyclerView)object4, (AjioEditText)object5, (ImageView)view3, (LinearLayout)view4, (LinearLayout)view5, (AjioTextView)object6);
                                            return luxeCategoryFacetSubtitleRowViewBinding;
                                        }
                                    }
                                }
                            }
    ...
    public static LuxeCategoryFacetSubtitleRowViewBinding inflate(LayoutInflater layoutInflater) {
        return LuxeCategoryFacetSubtitleRowViewBinding.inflate(layoutInflater, null, false);
    }

    public static LuxeCategoryFacetSubtitleRowViewBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean bl2) {
        int n3 = R$layout.luxe_category_facet_subtitle_row_view;
        layoutInflater = layoutInflater.inflate(n3, viewGroup, false);
        if (bl2) {
            viewGroup.addView((View)layoutInflater);
        }
        return LuxeCategoryFacetSubtitleRowViewBinding.bind((View)layoutInflater);
    }
