...
public final class WishlistData {
    ...
    public WishlistData(PopUpDialogModel popUpDialogModel, PopUpDialogModel popUpDialogModel2) {
        this.inAppPopUpDialogModel = popUpDialogModel;
        this.systemDialogModel = popUpDialogModel2;
    }

    public /* synthetic */ WishlistData(PopUpDialogModel popUpDialogModel, PopUpDialogModel popUpDialogModel2, int n3, DefaultConstructorMarker defaultConstructorMarker) {
        int n4 = n3 & 1;
        if (n4 != 0) {
    ...
    public static /* synthetic */ WishlistData copy$default(WishlistData wishlistData, PopUpDialogModel popUpDialogModel, PopUpDialogModel popUpDialogModel2, int n3, Object object) {
        int n4 = n3 & 1;
        if (n4 != 0) {
            popUpDialogModel = wishlistData.inAppPopUpDialogModel;
        }
        if ((n3 &= 2) != 0) {
            popUpDialogModel2 = wishlistData.systemDialogModel;
        }
        return wishlistData.copy(popUpDialogModel, popUpDialogModel2);
    }
    ...
    public final WishlistData copy(PopUpDialogModel popUpDialogModel, PopUpDialogModel popUpDialogModel2) {
        WishlistData wishlistData = new WishlistData(popUpDialogModel, popUpDialogModel2);
        return wishlistData;
    }
    ...
    public boolean equals(Object object) {
        ...
        boolean bl3 = object instanceof WishlistData;
        if (!bl3) {
            return false;
        }
        object = (WishlistData)object;
        PopUpDialogModel popUpDialogModel = this.inAppPopUpDialogModel;
        PopUpDialogModel popUpDialogModel2 = ((WishlistData)object).inAppPopUpDialogModel;
        bl3 = Intrinsics.areEqual(popUpDialogModel, popUpDialogModel2);
        if (!bl3) {
            return false;
        }
        popUpDialogModel = this.systemDialogModel;
        object = ((WishlistData)object).systemDialogModel;
    ...
    public String toString() {
        PopUpDialogModel popUpDialogModel = this.inAppPopUpDialogModel;
        PopUpDialogModel popUpDialogModel2 = this.systemDialogModel;
        StringBuilder stringBuilder = new StringBuilder("WishlistData(inAppPopUpDialogModel=");
