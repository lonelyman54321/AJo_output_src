...
public final class SizeChartAttribute {
    ...
    public /* synthetic */ SizeChartAttribute(String string2, String string3, String string4, int n3, DefaultConstructorMarker defaultConstructorMarker) {
        int n4 = n3 & 1;
        if (n4 != 0) {
            string2 = null;
        }
