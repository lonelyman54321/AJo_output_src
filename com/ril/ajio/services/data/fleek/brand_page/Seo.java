...
public final class Seo {
    ...
    public Seo(String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9, String string10, String string11, String string12, String string13, String string14) {
        ...
        this.seoTitle = string5;
        this.twitterTitle = string6;
        this.metaDescription = string7;
        this.twitterDescription = string8;
        this.metaKeyword = string9;
        this.twitterKeyword = string10;
        this.topDescription = string11;
        this.bottomDescription = string12;
        this.topBrands = string13;
        this.topSearches = string14;
    }
    ...
    public static /* synthetic */ Seo copy$default(Seo seo, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9, String string10, String string11, String string12, String string13, String string14, int n3, Object object) {
        ...
        int n4 = n3;
        int n7 = n3 & 1;
        String string15 = n7 != 0 ? seo.pageUrl : string2;
        int n8 = n4 & 2;
        String string16 = n8 != 0 ? seo2.canonicalUrl : string3;
        int n10 = n4 & 4;
        String string17 = n10 != 0 ? seo2.pageTitle : string4;
        int n14 = n4 & 8;
        String string18 = n14 != 0 ? seo2.seoTitle : string5;
        int n15 = n4 & 0x10;
        String string19 = n15 != 0 ? seo2.twitterTitle : string6;
        int n16 = n4 & 0x20;
        String string20 = n16 != 0 ? seo2.metaDescription : string7;
        int n17 = n4 & 0x40;
        String string21 = n17 != 0 ? seo2.twitterDescription : string8;
        int n18 = n4 & 0x80;
        String string22 = n18 != 0 ? seo2.metaKeyword : string9;
        int n19 = n4 & 0x100;
        String string23 = n19 != 0 ? seo2.twitterKeyword : string10;
        int n20 = n4 & 0x200;
        String string24 = n20 != 0 ? seo2.topDescription : string11;
        int n21 = n4 & 0x400;
        String string25 = n21 != 0 ? seo2.bottomDescription : string12;
        int n22 = n4 & 0x800;
        String string26 = n22 != 0 ? seo2.topBrands : string13;
        String string27 = (n4 &= 0x1000) != 0 ? seo2.topSearches : string14;
        string2 = string15;
        string3 = string16;
        string4 = string17;
        string5 = string18;
    ...
    public boolean equals(Object object) {
        ...
        String string3 = ((Seo)object).pageUrl;
        ...
        string3 = ((Seo)object).twitterTitle;
        bl3 = Intrinsics.areEqual(string2, string3);
        if (!bl3) {
            return false;
        }
        ...
        string2 = this.bottomDescription;
        string3 = ((Seo)object).bottomDescription;
        bl3 = Intrinsics.areEqual(string2, string3);
        if (!bl3) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        n4 = (n4 + n3) * 31;
        string3 = this.bottomDescription;
        if (string3 == null) {
            n3 = 0;
            string3 = null;
        } else {
    ...
    public String toString() {
        ...
        String string5 = this.seoTitle;
        String string6 = this.twitterTitle;
        String string7 = this.metaDescription;
        String string8 = this.twitterDescription;
        String string9 = this.metaKeyword;
        String string10 = this.twitterKeyword;
        String string11 = this.topDescription;
        String string12 = this.bottomDescription;
        String string13 = this.topBrands;
        String string14 = this.topSearches;
        object = og_1.a("Seo(pageUrl=", string2, ", canonicalUrl=", string3, ", pageTitle=");
        X50.a((StringBuilder)object, string4, ", seoTitle=", string5, ", twitterTitle=");
        X50.a((StringBuilder)object, string6, ", metaDescription=", string7, ", twitterDescription=");
        X50.a((StringBuilder)object, string8, ", metaKeyword=", string9, ", twitterKeyword=");
        X50.a((StringBuilder)object, string10, ", topDescription=", string11, ", bottomDescription=");
        X50.a((StringBuilder)object, string12, ", topBrands=", string13, ", topSearches=");
