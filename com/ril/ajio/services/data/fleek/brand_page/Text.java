...
public final class Text {
    ...
    public boolean equals(Object object) {
        ...
        Object object3 = ((Text)object).value;
    ...
    public String toString() {
        ...
        String string4 = this.colour;
        String string5 = this.fontWeight;
        Integer n3 = this.x;
        Integer n4 = this.y;
        charSequence = og_1.a("Text(value=", (String)charSequence, ", fontFamily=", string2, ", fontSize=");
        X50.a((StringBuilder)charSequence, string3, ", colour=", string4, ", fontWeight=");
