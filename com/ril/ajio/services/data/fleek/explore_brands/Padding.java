...
public final class Padding {
    ...
    public static /* synthetic */ Padding copy$default(Padding padding, String string2, String string3, String string4, String string5, int n3, Object object) {
        ...
        if ((n4 = n3 & 2) != 0) {
            string3 = padding.left;
        }
        if ((n4 = n3 & 4) != 0) {
            string4 = padding.right;
        }
        if ((n3 &= 8) != 0) {
            string5 = padding.top;
        }
    ...
    public boolean equals(Object object) {
        ...
        String string2 = this.bottom;
        String string3 = ((Padding)object).bottom;
        bl3 = Intrinsics.areEqual(string2, string3);
        if (!bl3) {
            return false;
        }
        string2 = this.left;
        string3 = ((Padding)object).left;
        bl3 = Intrinsics.areEqual(string2, string3);
        if (!bl3) {
            return false;
        }
    ...
    public String toString() {
        String string2 = this.bottom;
        String string3 = this.left;
        String string4 = this.right;
        String string5 = this.top;
        return ko_0.a(og_1.a("Padding(bottom=", string2, ", left=", string3, ", right="), string4, ", top=", string5, ")");
    }
}
