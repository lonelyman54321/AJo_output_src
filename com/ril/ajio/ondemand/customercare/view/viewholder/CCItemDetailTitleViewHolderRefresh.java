...
public final class CCItemDetailTitleViewHolderRefresh
extends uv_2 {
    private final TextView titleTv;

    public CCItemDetailTitleViewHolderRefresh(View view, i82_0 i82_02) {
        Intrinsics.checkNotNullParameter(view, "itemView");
        super(view, i82_02);
        int n3 = R$id.row_cc_item_detail_tv_title;
