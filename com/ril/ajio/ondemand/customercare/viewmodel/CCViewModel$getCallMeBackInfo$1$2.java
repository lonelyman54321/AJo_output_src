...
final class CCViewModel$getCallMeBackInfo$1$2
implements fs0_2 {
    final /* synthetic */ CCViewModel this$0;

    public CCViewModel$getCallMeBackInfo$1$2(CCViewModel cCViewModel) {
        this.this$0 = cCViewModel;
    }

    public final Object emit(DataCallback dataCallback, f80_0 f80_02) {
        CCViewModel.access$getCcCallMeBackInfoMLD$p(this.this$0).k(dataCallback);
        return Unit.a;
    }
}
