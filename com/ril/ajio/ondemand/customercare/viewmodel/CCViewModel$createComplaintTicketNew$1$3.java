...
final class CCViewModel$createComplaintTicketNew$1$3
implements fs0_2 {
    final /* synthetic */ CCViewModel this$0;

    public CCViewModel$createComplaintTicketNew$1$3(CCViewModel cCViewModel) {
        this.this$0 = cCViewModel;
    }

    public final Object emit(DataCallback dataCallback, f80_0 f80_02) {
        CCViewModel.access$get_ccComplaintNewAttachInfoMLD$p(this.this$0).k(dataCallback);
        return Unit.a;
    }
}
