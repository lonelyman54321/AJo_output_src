...
extends Evaluator$AttributeKeyPair {
    public Evaluator$AttributeWithValueEnding(String string2, String string3) {
    ...
    public boolean matches(Element object, Element object2) {
        ...
        if (!bl2) return false;
        object = this.key;
        bl2 = ((String)(object = Normalizer.lowerCase(((Node)object2).attr((String)object)))).endsWith((String)(object2 = this.value));
        if (!bl2) return false;
        return true;
    }
