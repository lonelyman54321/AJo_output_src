...
public final class ViewPager$f
extends a {
    public final /* synthetic */ ViewPager a;

    public ViewPager$f(ViewPager viewPager) {
        this.a = viewPager;
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(View object, C2 c2) {
        ...
        object = this.a;
        Uk2 uk2 = ((ViewPager)((Object)object)).mAdapter;
        int n7 = 1;
        ...
        c2.r(n4 != 0);
        n4 = (int)(((ViewPager)((Object)object)).canScrollHorizontally(n7) ? 1 : 0);
        if (n4 != 0) {
            n4 = 4096;
            c2.a(n4);
        }
        if ((n3 = ((ViewPager)((Object)object)).canScrollHorizontally(n4 = -1)) != 0) {
            n3 = 8192;
            c2.a(n3);
        }
    }
    ...
    public final boolean performAccessibilityAction(View view, int n3, Bundle bundle) {
        ...
        if (n3 != n4) {
            ...
            n4 = (int)(viewPager.canScrollHorizontally(-1) ? 1 : 0);
            if (n4 != 0) {
                n4 = viewPager.mCurItem - n7;
                viewPager.setCurrentItem(n4);
                return n7 != 0;
            }
            return false;
        }
        n4 = (int)(viewPager.canScrollHorizontally(n7) ? 1 : 0);
        if (n4 != 0) {
            n4 = viewPager.mCurItem + n7;
            viewPager.setCurrentItem(n4);
            return n7 != 0;
