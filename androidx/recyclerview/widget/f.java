...
extends AnimatorListenerAdapter {
    ...
    public f(View view, ViewPropertyAnimator viewPropertyAnimator, DefaultItemAnimator defaultItemAnimator, RecyclerView$B recyclerView$B) {
    ...
    public final void onAnimationEnd(Animator object) {
        ...
        ((DefaultItemAnimator)object).q.remove(recyclerView$B);
