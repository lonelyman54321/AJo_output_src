...
implements Runnable {
    ...
    public /* synthetic */ s5(OrderEvent orderEvent, CartOrder cartOrder, Product product) {
        this.a = orderEvent;
        this.b = cartOrder;
        this.c = product;
    }
    ...
    public final void run() {
        ...
        object = Unit.a;
        p5_0.d(p5_02, "affise_validation", "affise validation", "order confirmation", (String)object2, "order confirmation screen", bundle);
    }
}
