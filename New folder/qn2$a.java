...
extends qn2 {
    ...
    public qn2$a(float f5, float f6, float f7, boolean bl2, boolean bl3, float f8, float f11) {
        super(3, false, false);
        this.c = f5;
        this.d = f6;
        this.e = f7;
    ...
    public final boolean equals(Object object) {
        ...
        int n3 = object instanceof qn2$a;
        if (n3 == 0) {
            return false;
        }
        object = (qn2$a)object;
        float f5 = this.c;
        float f6 = ((qn2$a)object).c;
        ...
        n3 = (int)(this.f ? 1 : 0);
        int n4 = ((qn2$a)object).f;
        if (n3 != n4) {
            return false;
        }
        n3 = (int)(this.g ? 1 : 0);
        n4 = (int)(((qn2$a)object).g ? 1 : 0);
        if (n3 != n4) {
            return false;
        }
        f6 = this.h;
    ...
    public final String toString() {
        StringBuilder stringBuilder = new StringBuilder("ArcTo(horizontalEllipseRadius=");
        float f5 = this.c;
        ...
        bl2 = this.g;
        stringBuilder.append(bl2);
        stringBuilder.append(", arcStartX=");
        f5 = this.h;
        stringBuilder.append(f5);
        stringBuilder.append(", arcStartY=");
        f5 = this.i;
