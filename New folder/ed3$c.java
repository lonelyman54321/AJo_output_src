...
implements OnGACuratedWidgetEventHandlerListener {
    public final void pushEECuratedWidgetOptionsImpressions(List list, int n3, String string2, String string3, String string4, String string5, String string6) {
        ...
        NewEEcommerceEventsRevamp.pushEECuratedWidgetOptionsImpression$default(AnalyticsManager.Companion.getInstance().getNewEEcommerceEventsRevamp(), list, n3, "landing screen", string3, "landing screen", string5, string6, null, 128, null);
    }
}
