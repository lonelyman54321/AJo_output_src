...
public final class lM$b
implements TextWatcher {
    public final /* synthetic */ lm_2 a;

    public lM$b(lm_2 lm_22) {
        this.a = lm_22;
    }
    ...
    public final void afterTextChanged(Editable object) {
        ...
        if ((view = ((lm_2)object2).F) == null) {
            Intrinsics.throwUninitializedPropertyAccessException(string3);
        } else {
            view2 = view;
        }
        if (object == null || (bl2 = b.i((String)(object2 = ((lm_2)object2).Y), string2 = object.toString(), false))) {
            bl4 = false;
        }
        view2.setEnabled(bl4);
    }
