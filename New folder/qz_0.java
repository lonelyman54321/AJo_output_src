 ...
 * Renamed from qZ
 */
public final class qz_0
implements al1_1,
eq2_0 {
    public final zp$l a;
    public final Nc$b b;

    public qz_0(zp$l zp$l, Gx$a gx$a) {
        this.a = zp$l;
        this.b = gx$a;
    }
    ...
    public final void b(int n3, int[] nArray, int[] nArray2, dl1_1 dl1_12) {
        this.a.c(dl1_12, n3, nArray, nArray2);
    }
    ...
    public final boolean equals(Object object) {
        ...
        boolean bl3 = object instanceof qz_0;
        if (!bl3) {
            return false;
        }
        object = (qz_0)object;
        zp$l zp$l = this.a;
        Object object2 = ((qz_0)object).a;
        bl3 = Intrinsics.areEqual(zp$l, object2);
        if (!bl3) {
            return false;
        }
        object2 = this.b;
        object = ((qz_0)object).b;
    ...
    public final long f(int n3, int n4, int n7, boolean bl2) {
        ...
        if (!bl2) {
            ...
            n7 = Math.min(n16, 0);
            l2 = f60.a(n7, n10, n3, n4);
        }
        return l2;
    }

    public final bl1_0 g(Ns2[] ns2Array, dl1_1 dl1_12, int n3, int[] nArray, int n4, int n7) {
        pz_0 pz_02 = new pz_0(ns2Array, this, n7, n3, dl1_12, nArray);
        return cl1_0.a(dl1_12, n7, n4, pz_02);
    }
    ...
    public final String toString() {
        StringBuilder stringBuilder = new StringBuilder("ColumnMeasurePolicy(verticalArrangement=");
        Object object = this.a;
        stringBuilder.append(object);
        stringBuilder.append(", horizontalAlignment=");
        object = this.b;
        stringBuilder.append(object);
