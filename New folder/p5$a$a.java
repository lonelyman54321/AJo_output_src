...
implements OnSendSuccessCallback {
    ...
    public p5$a$a(OrderCancelEvent orderCancelEvent, Ref$ObjectRef ref$ObjectRef, Product product) {
    ...
    public final void handle() {
        ...
        object2 = Unit.a;
        p5_0.d(p5_02, "affise_callback", "affise callback ", "cancel order - success", (String)object3, "order cancellation screen", bundle);
    }
}
