 ...
 * Renamed from vD1
 */
public final class vd1_1
extends Fragment
implements oD1$a {
    public static final vD1$a Companion;
    public vD1$b a;
    ...
    static {
        vD1$a vD1$a;
        Companion = vD1$a = new Object();
    }

    public vd1_1() {
        Object object = new rd1_1(this, 0);
    ...
    public final void onAttach(Context object) {
        ...
        Intrinsics.checkNotNull(object, "null cannot be cast to non-null type com.ril.ajio.home.category.revamp.LuxCMSSubCategoryDetailFragment.OnSubCategoryListener");
        object = (vD1$b)object;
        this.a = object;
    }
    ...
    public final void onCreate(Bundle object) {
        ...
        if (object != null) {
            ...
            boolean bl3 = true;
            String string3 = null;
            if (object != null && (bl2 = object.containsKey((String)(object2 = "NAVIGATION"))) == bl3) {
                boolean bl4;
                ...
                if (object != null) {
                    ...
                    if (n3 >= n4) {
                        object = (Parcelable)pd1_2.a((Bundle)object);
                    } else {
                        bl4 = (object = object.getParcelable((String)object2)) instanceof CMSNavigation;
                        if (!bl4) {
                            bl2 = false;
                            object = null;
                        }
                ...
                if (object != null && (object = ((CMSNavigation)object).getChildDetails()) != null) {
                    ...
                    while (bl4 = object.hasNext()) {
                        object2 = (CMSNavigation)object.next();
                        ArrayList arrayList = new ArrayList();
                        Object object3 = ((CMSNavigation)object2).getChildDetails();
                        if (object3 != null) {
                            object3 = ((CMSNavigation)object2).getChildDetails();
                            Intrinsics.checkNotNull(object3);
                            object3 = (Collection)object3;
                            arrayList.addAll(object3);
                        }
                        if ((object3 = this.f) == null) continue;
                        object2 = ((AbstractMap)object3).put(object2, arrayList);
                    }
                }
            }
            if ((object = this.getArguments()) != null && (bl2 = object.containsKey((String)(object2 = "STORE_INFO_LIST"))) == bl3 && (object = this.getArguments()) != null) {
                n3 = Build.VERSION.SDK_INT;
                if (n3 >= n4) {
                    object = qd1_2.a((Bundle)object);
                } else {
                    n4 = (object = object.getSerializable((String)object2)) instanceof ArrayList;
                    if (n4 == 0) {
                        bl2 = false;
                        object = null;
                    }
    ...
    public final void onViewCreated(View object, Bundle object2) {
        ...
        object2 = this.f;
        string2 = this.g;
        object = new od1_2(this, (LinkedHashMap)object2, string2);
        this.c = object;
        object = this.b;
        n3 = 0;
        object2 = null;
