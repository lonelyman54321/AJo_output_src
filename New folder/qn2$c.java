...
extends qn2 {
    ...
    public qn2$c(float f5, float f6, float f7, float f8, float f11, float f12) {
        super(2, true, false);
        this.c = f5;
        this.d = f6;
        this.e = f7;
    ...
    public final boolean equals(Object object) {
        ...
        int n3 = object instanceof qn2$c;
        if (n3 == 0) {
            return false;
        }
        object = (qn2$c)object;
        float f5 = this.c;
        float f6 = ((qn2$c)object).c;
    ...
    public final String toString() {
        StringBuilder stringBuilder = new StringBuilder("CurveTo(x1=");
        float f5 = this.c;
