...
implements OnSendFailedCallback {
    ...
    public final void handle(HttpResponse object) {
        ...
        object = Unit.a;
        p5_0.d(p5_02, "affise_callback", "affise callback ", "purchase - failure", (String)object2, "order confirmation screen", bundle);
    }
}
