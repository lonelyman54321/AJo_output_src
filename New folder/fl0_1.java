 ...
 * Renamed from FL0
 */
public final class fl0_1
implements mn1_0 {
    public final dh_1 a;
    public final yc1_2 b;

    public fl0_1(dh_1 dh_12, yc1_2 yc1_22) {
    ...
    public final Pair a(String string2) {
        ...
        if (object != null) {
            ...
            charSequence.append(" data from FILE in-memory");
    ...
    public final Object d(String object, sn1_1 sn1_12) {
        ...
        if (object5 != null) {
            object2 = ((String)object).concat(" data found in FILE disk memory");
    ...
    public final boolean e(String string2, Pair pair) {
        ...
        if (yc1_22 != null) {
            ...
            charSequence.append(string2);
            charSequence.append(" data in FILE in-memory");
            charSequence = charSequence.toString();
            String string3 = "FileDownload";
            yc1_22.b(string3, (String)charSequence);
        }
        return this.a.c.a().a(pair, string2);
    }
    ...
    public final Object f(String object, sn1_1 sn1_12) {
        ...
        if (object3 != null) {
            object = ((String)object).concat(" data found in FILE in-memory");
            String string2 = "FileDownload";
    ...
    public final File g(String string2) {
        ...
        yc1_2 yc1_22 = this.b;
        if (yc1_22 != null) {
            CharSequence charSequence = new StringBuilder("FILE In-Memory cache miss for ");
            charSequence.append(string2);
        ...
        return this.a.c.b().c(string2);
    }

    public final Pair h(String string2) {
        String string3 = "key";
        Intrinsics.checkNotNullParameter(string2, string3);
        vg1_1 vg1_12 = this.a.c.a();
        vg1_12.getClass();
        Intrinsics.checkNotNullParameter(string2, string3);
