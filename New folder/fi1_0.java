...
implements FilenameFilter {
    public final boolean accept(File object, String string2) {
        ...
        object2[0] = "crash_log_";
        object2[1] = "shield_log_";
        object2[2] = "thread_check_log_";
        object = xh2_0.a((Object[])object2, n3, "^(%s|%s|%s)[0-9]+.json$", "format(format, *args)");
