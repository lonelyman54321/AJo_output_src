...
extends qn2 {
    ...
    public qn2$g(float f5, float f6, float f7, float f8) {
        boolean bl2 = true;
    ...
    public final boolean equals(Object object) {
        ...
        int n3 = object instanceof qn2$g;
        if (n3 == 0) {
            return false;
        }
        object = (qn2$g)object;
        float f5 = this.c;
        float f6 = ((qn2$g)object).c;
    ...
    public final String toString() {
        StringBuilder stringBuilder = new StringBuilder("QuadTo(x1=");
        float f5 = this.c;
