...
extends qn2 {
    ...
    public qn2$h(float f5, float f6, float f7, float f8) {
        super(2, true, false);
        this.c = f5;
        this.d = f6;
        this.e = f7;
    ...
    public final boolean equals(Object object) {
        ...
        int n3 = object instanceof qn2$h;
        if (n3 == 0) {
            return false;
        }
        object = (qn2$h)object;
        float f5 = this.c;
        float f6 = ((qn2$h)object).c;
    ...
    public final String toString() {
        StringBuilder stringBuilder = new StringBuilder("ReflectiveCurveTo(x1=");
        float f5 = this.c;
