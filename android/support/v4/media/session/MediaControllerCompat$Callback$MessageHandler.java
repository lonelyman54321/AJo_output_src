...
extends Handler {
    ...
    public void handleMessage(Message object) {
        int n3 = this.mRegistered;
        if (n3 == 0) {
            return;
        }
        n3 = ((Message)object).what;
        switch (n3) {
            default: {
                break;
            }
            ...
            case 12: {
                ...
                mediaControllerCompat$Callback.onShuffleModeChanged(n4);
                break;
            }
            case 11: {
                MediaControllerCompat$Callback mediaControllerCompat$Callback = this.this$0;
            ...
            case 9: {
                ...
                mediaControllerCompat$Callback.onRepeatModeChanged(n7);
                break;
            }
            case 8: {
                object = this.this$0;
