...
public class IMediaControllerCallback$_Parcel {
    public static /* synthetic */ Object access$000(Parcel parcel, Parcelable.Creator creator) {
        return IMediaControllerCallback$_Parcel.readTypedObject(parcel, creator);
    }

    public static /* synthetic */ void access$100(Parcel parcel, Parcelable parcelable, int n3) {
        IMediaControllerCallback$_Parcel.writeTypedObject(parcel, parcelable, n3);
    }

    public static /* synthetic */ void access$200(Parcel parcel, List list, int n3) {
        IMediaControllerCallback$_Parcel.writeTypedList(parcel, list, n3);
    }
